...
namespace VIS.Models
{
    ...
    public class AccountFormModel
    {
        ...
        /// <param name="VAB_LocFrom_ID"></param>
        ...
        public AccountingObjects SaveAccount(Ctx ctx, int VAF_Client_ID, int VAF_Org_ID, int VAB_AccountBook_ID, int VAF_Account_ID, int VAB_SubAcct_ID, int VAM_Product_ID,
            int VAB_BusinessPartner_ID, int VAF_OrgTrx_ID, int VAB_LocFrom_ID, int VAB_LocTo_ID, int C_SRegion_ID, int VAB_Project_ID, int VAB_Promotion_ID,
            ...
            int UserElement5_ID, int UserElement6_ID, int UserElement7_ID, int UserElement8_ID, int UserElement9_ID, string Alias)
        {
            ...
            if (Util.GetValueOfInt(DBase.DB.ExecuteScalar(qry, null, null)) > 0)
            {
                acct = MVABAccount.Get(ctx, VAF_Client_ID, VAF_Org_ID, VAB_AccountBook_ID, VAF_Account_ID, VAB_SubAcct_ID, VAM_Product_ID, VAB_BusinessPartner_ID, VAF_OrgTrx_ID,
                   VAB_LocFrom_ID, VAB_LocTo_ID, C_SRegion_ID, VAB_Project_ID, VAB_Promotion_ID, VAB_BillingCode_ID, User1_ID, User2_ID, UserElement1_ID, UserElement2_ID,
        ...
        private AccountingObjects LoadInfo(int VAB_Acct_ValidParameter_ID, int VAB_AccountBook_ID)
        {
            ...
            try
            {
                if (dr.Read())
                {
                    ...
                    //obj.VAB_LocFrom_ID = Convert.ToInt32(dr["VAB_LocFrom_ID"]);
                    //obj.VAB_LocTo_ID = Convert.ToInt32(dr["VAB_LocTo_ID"]);
