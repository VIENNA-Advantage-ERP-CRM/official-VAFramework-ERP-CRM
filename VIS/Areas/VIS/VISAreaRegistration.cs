...
namespace VIS
{
    public class VISAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            VAdvantage.ModuleBundles.RegisterScriptBundle(modScript, "VIS", -10);
            VAdvantage.ModuleBundles.RegisterScriptBundle(modScript_v1, "VIS1_0", -11);
            VAdvantage.ModuleBundles.RegisterScriptBundle(modScript_v2, "VIS2_0", -12);

            VAdvantage.ModuleBundles.RegisterStyleBundle(style, "VIS", -10);
