...
namespace VIS
{
    public class VISAreaRegistration : AreaRegistration
    {
        ...
        public override void RegisterArea(AreaRegistrationContext context)
        {
            ...
            ScriptBundle modScript_v3 = new ScriptBundle("~/Areas/VIS/Scripts/VIS_v3");
            ...
            //modScript_v2.Include("~/Areas/VIS/Scripts/app/windowframe.js"); //Old design , do-not alter 

            //modScript_v3.Include(
            ...
            VAdvantage.ModuleBundles.RegisterScriptBundle(modScript_v2, "VIS1_0", -2);
            VAdvantage.ModuleBundles.RegisterScriptBundle(modScript_v3, "VIS2_0", -3);
