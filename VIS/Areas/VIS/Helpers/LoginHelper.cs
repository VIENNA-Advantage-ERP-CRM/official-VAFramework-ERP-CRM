...
namespace VIS.Helpers
{
    ...
    public class LoginHelper
    {
        ...
        private static void GetOrgsAddSummary(List<KeyNamePair> list, int Summary_Org_ID, String Summary_Name, MVAFRole role, Ctx ctx)
        {
            ...
            MVAFTreeInfo tree = MVAFTreeInfo.Get(ctx, role.GetVAF_Tree_Org_ID(), null);
        ...
        public static List<KeyNamePair> GetWarehouse(int org)
        {
            ...
            try
            {
                ...
                do
                {
                    int VAM_Warehouse_ID = Util.GetValueOfInt(dr[0].ToString());
                    String Name = dr[1].ToString();
        ...
        internal static LoginContext GetLoginContext(LoginModel model)
        {
            ...
            //    __VAM_Warehouse_ID = model.Login2Model.Warehouse,
