; (function (VIS, $) {
    ...
    function Find(windowNo, curTab, minRecord) {
        ...
        var txtQryName, drpSavedQry, drpColumns, drpOp, drpDynamicOp, chkDynamic, txtYear, txtMonth, txtDay, txtStatus, chkFullDay, spanAddFilter;
