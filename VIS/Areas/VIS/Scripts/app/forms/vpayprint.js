        ...
        function customDesign() {
            ...
            var designPSelectInfo = " <div class='vis-pPrintInfo'>"  // div pSelectInfo starts here                            
                + " <div class='vis-paymentselect-field' style='margin-top: 8px;'>"  // div PaySelection starts here
                             ...
                             + " <input type='checkbox' id='VIS_chkShowPrintPayment_" + $self.windowNo + "'>"
                             ...
                             + '<div class="input-group vis-input-wrap"><div class="vis-control-wrap">'
                             + " <input type='text' name='vis-name vis-fieldreadonly' class='vis-fieldreadonly' disabled id='VIS_txtBankAccount_" + $self.windowNo + "' MaxLength='50'>"
                             ...
                             + '<div class="input-group vis-input-wrap"><div class="vis-control-wrap">'
                             + " <input type='text' class='vis-fieldreadonly' disabled id='VIS_txtCurrentBal_" + $self.windowNo + "' MaxLength='50'>"
                             ...
                             + '<div class="input-group vis-input-wrap"><div class="vis-control-wrap">'
                             + " <input type='text' class='vis-fieldreadonly' disabled id='VIS_txtCurrency_" + $self.windowNo + "' MaxLength='50'>"
                             ...
                             + '<div class="input-group vis-input-wrap"><div class="vis-control-wrap">'
                             + " <input type='number' name='vis-name'  id='VIS_txtCheckNo_" + $self.windowNo + "' MaxLength='50'>"
                             ...
                             + '<div class="input-group vis-input-wrap"><div class="vis-control-wrap">'
                             + " <input type='text' class='vis-fieldreadonly' disabled id='VIS_txtNoOfPayments_" + $self.windowNo + "' MaxLength='50'>"
