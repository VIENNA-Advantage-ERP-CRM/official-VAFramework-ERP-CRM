   ...
   */
    ...
    */
    ...
    GridTab.prototype.loadHeaderPanelItems = function () {
        if (this.gTab.hItems && this.gTab.hItems.length > 0) {
            this.isHeaderPanel = true;
            headerPanel = this.gTab.hItems;
        }
    };
