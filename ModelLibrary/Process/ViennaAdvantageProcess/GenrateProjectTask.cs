      ...
      //  private int C_Project_ID = 0;
       ...
       // private int C_ProjectTask_ID = 0;
        ...
        protected override String DoIt()
        {
            ...
            int[] allids = VAdvantage.Model.X_C_CampaignPhase.GetAllIDs("C_CampaignPhase", "C_CampaignType_ID=" + C_CampaignType_ID + " and VAF_Client_ID = " + GetVAF_Client_ID() + " Order By SEQNO ", Get_TrxName());
            ...
            for (int i = 0; i < allids.Length; i++)
            {
                ...
                if (C_CampaignPhase_ID != 0)
                {
                    ...
                    int[] allids1 = VAdvantage.Model.X_C_CampaignTask.GetAllIDs("C_CampaignTask", "C_CampaignPhase_ID=" + C_CampaignPhase_ID + " and VAF_Client_ID = " + GetVAF_Client_ID() + " Order By SEQNO ", Get_TrxName());
