	 ...
	 */
        ...
        */
        protected override String DoIt()
        {
            ...
            VAdvantage.Model.MVABProject fromProject = new VAdvantage.Model.MVABProject(GetCtx(), _VAB_Project_ID, Get_TrxName());
           ...
           // MBPartner bp = new MBPartner(GetCtx(), VAB_BusinessPartner_id, Get_TrxName());
            ...
            if (VAB_ProjectLine_ID != 0)
            {
               ...
               // String sql = "select VAB_DocTypes_id from VAB_DocTypes where name = 'Standard Order'";
                ...
                order.SetVAM_PriceList_ID(Util.GetValueOfInt(fromProject.GetVAM_PriceList_ID()));
