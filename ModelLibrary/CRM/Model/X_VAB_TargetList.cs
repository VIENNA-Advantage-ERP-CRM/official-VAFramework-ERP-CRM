...
public class X_VAB_TargetList : PO
{
public X_VAB_TargetList (Context ctx, int C_TargetList_ID, Trx trxName) : base (ctx, C_TargetList_ID, trxName)
{
...
public X_VAB_TargetList (Ctx ctx, int C_TargetList_ID, Trx trxName) : base (ctx, C_TargetList_ID, trxName)
{
/** if (C_TargetList_ID == 0)
{
SetVAB_MasterTargetList_ID (0);
...
*/
public X_VAB_TargetList (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_VAB_TargetList (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_VAB_TargetList (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_VAB_TargetList()
{
...
{
StringBuilder sb = new StringBuilder ("X_VAB_TargetList[").Append(Get_ID()).Append("]");
return sb.ToString();
}
/** Set Address 1.
