namespace VAdvantage.Model
{
    ...
    using System.Data;/** Generated Model for C_MasterForecast
 ...
 *  @version Vienna Framework 1.1.1 - $Id$ */
    public class X_C_MasterForecast : PO
    {
        ...
        {/** if (C_MasterForecast_ID == 0){SetC_MasterForecast_ID (0);SetC_Period_ID (0);SetName (null);} */
        }
...
*/
        public X_C_MasterForecast(Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName) { }/** Load Constructor 
@param ctx context
@param rs result set 
@param trxName transaction
*/
        public X_C_MasterForecast(Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName) { }/** Load Constructor 
@param ctx context
@param rs result set 
@param trxName transaction
*/
        public X_C_MasterForecast(Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName) { }/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
        static X_C_MasterForecast() { Table_ID = Get_Table_ID(Table_Name); model = new KeyNamePair(Table_ID, Table_Name); }/** Serial Version No */
        static long serialVersionUID = 27900626543370L;/** Last Updated Timestamp 4/15/2021 3:40:26 PM */
        public static long updatedMS = 1618501226581L;/** AD_Table_ID=1000246 */
        public static int Table_ID; // =1000246;
...
@return info
*/
        public override String ToString() { StringBuilder sb = new StringBuilder("X_C_MasterForecast[").Append(Get_ID()).Append("]"); return sb.ToString(); }/** Set User/Contact.
...
@return User within the system - Internal or Customer/Prospect Contact. */
        public int GetAD_User_ID() { Object ii = Get_Value("AD_User_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }/** Set Bulk Adjustment.
@param BulkAdjustment Bulk Adjustment */
        public void SetBulkAdjustment(String BulkAdjustment) { if (BulkAdjustment != null && BulkAdjustment.Length > 10) { log.Warning("Length > 10 - truncated"); BulkAdjustment = BulkAdjustment.Substring(0, 10); } Set_Value("BulkAdjustment", BulkAdjustment); }/** Get Bulk Adjustment.
@return Bulk Adjustment */
        public String GetBulkAdjustment() { return (String)Get_Value("BulkAdjustment"); }/** Set Currency Rate Type.
...
@return Master Forecast */
        public int GetC_MasterForecast_ID() { Object ii = Get_Value("C_MasterForecast_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }
...
@return Period of the Calendar */
        public int GetC_Period_ID() { Object ii = Get_Value("C_Period_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }/** Set Comments.
...
@return Copy Lines */
        public String GetCopyLines() { return (String)Get_Value("CopyLines"); }/** Set Create Version.
@param CreateVersion Create new version on the behalf of base mater forecast of a period */
        public void SetCreateVersion(String CreateVersion) { if (CreateVersion != null && CreateVersion.Length > 1) { log.Warning("Length > 1 - truncated"); CreateVersion = CreateVersion.Substring(0, 1); } Set_Value("CreateVersion", CreateVersion); }/** Get Create Version.
@return Create new version on the behalf of base mater forecast of a period */
        public String GetCreateVersion() { return (String)Get_Value("CreateVersion"); }/** Set Current Version.
@param CurrentVersion Reflects your current version master forecast of a period */
        public void SetCurrentVersion(Boolean CurrentVersion) { Set_Value("CurrentVersion", CurrentVersion); }/** Get Current Version.
@return Reflects your current version master forecast of a period */
        public Boolean IsCurrentVersion() { Object oo = Get_Value("CurrentVersion"); if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo); } return false; }/** Set Account Date.
...
@param DocAction The targeted status of the document */
        public void SetDocAction(String DocAction)
        {
            if (!IsDocActionValid(DocAction))
                throw new ArgumentException("DocAction Invalid value - " + DocAction + " - Reference_ID=135 - -- - AP - CL - CO - IN - PO - PR - RA - RC - RE - RJ - VO - WC - XL"); if (DocAction != null && DocAction.Length > 10) { log.Warning("Length > 10 - truncated"); DocAction = DocAction.Substring(0, 10); }
...
@return Indicates if this document requires approval */
        public Boolean IsApproved() { Object oo = Get_Value("IsApproved"); if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo); } return false; }/** Set Include Oppurtunity.
@param IsIncludeOpp Include open Oppurtunity */
        public void SetIsIncludeOpp(Boolean IsIncludeOpp) { Set_Value("IsIncludeOpp", IsIncludeOpp); }/** Get Include Oppurtunity.
@return Include open Oppurtunity */
        public Boolean IsIncludeOpp() { Object oo = Get_Value("IsIncludeOpp"); if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo); } return false; }/** Set Price List.
...
@return Process Now */
        public Boolean IsProcessing() { Object oo = Get_Value("Processing"); if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo); } return false; }/** Set TRXDATE.
