                    ...
                    for (int asch = 0; asch < _ListAcctSch.Count; asch++)
                    {
                        ...
                        for (int i = 0; i < _lines.Length; i++)
                        {
                            ...
                            MVABAccount expense = MVABAccount.Get(GetCtx(), GetVAF_Client_ID(), GetVAF_Org_ID(), AccountingSchema.GetVAB_AccountBook_ID(), line.GetAccount_ID(), line.GetVAB_SubAcct_ID(), line.GetVAM_Product_ID(), line.GetVAB_BusinessPartner_ID(), line.GetVAF_OrgTrx_ID(),
                                line.GetVAB_LocFrom_ID(), line.GetVAB_LocTo_ID(), line.GetVAB_SalesRegionState_ID(), line.GetVAB_Project_ID(), line.GetVAB_Promotion_ID(), line.GetVAB_BillingCode_ID(), line.GetUser1_ID(), line.GetUser2_ID(), line.GetUserElement1_ID(), line.GetUserElement2_ID(),
