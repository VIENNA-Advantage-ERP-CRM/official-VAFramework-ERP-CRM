    ...
    public class AEnv
    {
       ...
       // private static bool? _workflow = null;
        ...
        public static GridWindowVO GetMWindowVO(Ctx ctx, int windowNo, int AD_Window_ID, int AD_Menu_ID)
        {
            ...
            string format = string.Format("{0}{1}{2}{3}{4}", AD_Window_ID, ctx.GetAD_Client_ID(),ctx.GetAD_Org_ID(), ctx.GetAD_Role_ID(), ctx.GetAD_Language());          //JID_1238: Addedd language to reset cache
