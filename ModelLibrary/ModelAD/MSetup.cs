...
namespace VAdvantage.Model
{
    public sealed class MSetup
    {
        ...
        public bool CreateAccounting(KeyNamePair currency, bool hasProduct, bool hasBPartner, bool hasProject, bool hasMCampaign, bool hasSRegion, FileStream AccountingFile, out string result)
        {
             ...
             *  Create Calendar
             */
            if (Common.Common.lstTableName.Contains("VAB_Calender")) // Update by Paramjeet Singh
            {
            ...
            if (Common.Common.lstTableName.Contains("VAB_Element")) // Update by Paramjeet Singh
            {
             ...
             */
            if (Common.Common.lstTableName.Contains("VAB_AccountBook"))// Update by Paramjeet Singh
            {
            ...
            try
            {
                if (Common.Common.lstTableName.Contains("VAB_AccountBook_Element"))// Update by Paramjeet Singh
                {
                    int VAF_Client_ID = m_client.GetVAF_Client_ID();
        ...
        private int CreateDocType(String Name, String PrintName, String DocBaseType, String DocSubTypeSO, int VAB_DocTypesShipment_ID, int VAB_DocTypesInvoice_ID, int StartNo, int GL_Category_ID, string postingCode)
        {
        ...
        /// <returns>doc type or 0 for error</returns>
        private int CreateDocType(String Name, String PrintName, String DocBaseType, String DocSubTypeSO, int VAB_DocTypesShipment_ID, int VAB_DocTypesInvoice_ID, int StartNo, int GL_Category_ID, bool isReturnTrx, bool IsCreateCounter, string postingCode)
        {
