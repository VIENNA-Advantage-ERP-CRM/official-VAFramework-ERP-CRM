namespace VAdvantage.Model
{
    ...
    using System.Data;/** Generated Model for AD_SysConfig
 *  @author Raghu (Updated) 
 *  @version Vienna Framework 1.1.1 - $Id$ */
    public class X_AD_SysConfig : PO
    {
        public X_AD_SysConfig(Context ctx, int AD_SysConfig_ID, Trx trxName)
            : base(ctx, AD_SysConfig_ID, trxName)
        {/** if (AD_SysConfig_ID == 0){SetAD_SysConfig_ID (0);SetName (null);} */
        }
        public X_AD_SysConfig(Ctx ctx, int AD_SysConfig_ID, Trx trxName)
            : base(ctx, AD_SysConfig_ID, trxName)
        {/** if (AD_SysConfig_ID == 0){SetAD_SysConfig_ID (0);SetName (null);} */
        }/** Load Constructor 
@param ctx context
...
*/
 ...
 added by ->Harwinder */
        ...
        static long serialVersionUID = 27762179909536L;/** Last Updated Timestamp 11/25/2016 11:46:32 AM */
        public static long updatedMS = 1480054592747L;/** AD_Table_ID=1000717 */
        public static int Table_ID; // =1000717;
...
@return info
*/
        public override String ToString() { StringBuilder sb = new StringBuilder("X_AD_SysConfig[").Append(Get_ID()).Append("]"); return sb.ToString(); }/** Set AD_SysConfig_ID.
@param AD_SysConfig_ID AD_SysConfig_ID */
        public void SetAD_SysConfig_ID(int AD_SysConfig_ID) { if (AD_SysConfig_ID < 1) throw new ArgumentException("AD_SysConfig_ID is mandatory."); Set_ValueNoCheck("AD_SysConfig_ID", AD_SysConfig_ID); }/** Get AD_SysConfig_ID.
@return AD_SysConfig_ID */
        public int GetAD_SysConfig_ID() { Object ii = Get_Value("AD_SysConfig_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }
        /** ConfigurationLevel AD_Reference_ID=1000263 */
        public static int CONFIGURATIONLEVEL_AD_Reference_ID = 1000263;/** Client = C */
...
@param ConfigurationLevel Configuration Level */
        ...
        {
            if (!IsConfigurationLevelValid(ConfigurationLevel))
                throw new ArgumentException("ConfigurationLevel Invalid value - " + ConfigurationLevel + " - Reference_ID=1000263 - C - O - S"); if (ConfigurationLevel != null && ConfigurationLevel.Length > 1) { log.Warning("Length > 1 - truncated"); ConfigurationLevel = ConfigurationLevel.Substring(0, 1); } Set_Value("ConfigurationLevel", ConfigurationLevel);
...
@param Value Search key for the record in the format required - must be unique */
        public void SetValue(String Value) { if (Value != null && Value.Length > 255) { log.Warning("Length > 255 - truncated"); Value = Value.Substring(0, 255); } Set_Value("Value", Value); }/** Get Search Key.
