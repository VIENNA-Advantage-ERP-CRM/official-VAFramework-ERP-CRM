...
namespace VAdvantage.Model
{
    public class MVAFClientDetail : X_VAF_ClientDetail
    {
        ...
        /// <param name="VAF_Tree_Org_ID">org tree</param>
        /// <param name="VAF_Tree_BPartner_ID">bp tree</param>
        /// <param name="VAF_Tree_Project_ID">project tree</param>
        /// <param name="VAF_Tree_SalesRegion_ID">sr tree</param>
        /// <param name="VAF_Tree_Product_ID">product tree</param>
        /// <param name="VAF_Tree_Campaign_ID">campaign tree</param>
        /// <param name="VAF_Tree_Activity_ID">activity tree</param>
        /// <param name="trxName">transaction</param>
        public MVAFClientDetail(MVAFClient client, int VAF_Tree_Org_ID, int VAF_Tree_BPartner_ID,
            int VAF_Tree_Project_ID, int VAF_Tree_SalesRegion_ID, int VAF_Tree_Product_ID,
            int VAF_Tree_Campaign_ID, int VAF_Tree_Activity_ID, Trx trxName):base(client.GetCtx(),0,trxName)
        {
            ...
            //
            SetVAF_Tree_Menu_ID(10);		//	HARDCODED
            //
            SetVAF_Tree_Org_ID(VAF_Tree_Org_ID);
            SetVAF_Tree_BPartner_ID(VAF_Tree_BPartner_ID);
            SetVAF_Tree_Project_ID(VAF_Tree_Project_ID);
            SetVAF_Tree_SalesRegion_ID(VAF_Tree_SalesRegion_ID);
            SetVAF_Tree_Product_ID(VAF_Tree_Product_ID);
            SetVAF_Tree_Campaign_ID(VAF_Tree_Campaign_ID);
            SetVAF_Tree_Activity_ID(VAF_Tree_Activity_ID);
            //
