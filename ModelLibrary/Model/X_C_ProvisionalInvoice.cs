...
using System;using System.Text;using VAdvantage.DataBase;using VAdvantage.Common;using VAdvantage.Classes;using VAdvantage.Process;using VAdvantage.Model;using VAdvantage.Utility;using System.Data;/** Generated Model for C_ProvisionalInvoice
 *  @author Raghu (Updated) 
 *  @version Vienna Framework 1.1.1 - $Id$ */
public class X_C_ProvisionalInvoice : PO{public X_C_ProvisionalInvoice (Context ctx, int C_ProvisionalInvoice_ID, Trx trxName) : base (ctx, C_ProvisionalInvoice_ID, trxName){/** if (C_ProvisionalInvoice_ID == 0){SetC_BPartner_ID (0);SetC_Currency_ID (0);// @C_Currency_ID@
SetC_DocType_ID (0);// -1
...
}public X_C_ProvisionalInvoice (Ctx ctx, int C_ProvisionalInvoice_ID, Trx trxName) : base (ctx, C_ProvisionalInvoice_ID, trxName){/** if (C_ProvisionalInvoice_ID == 0){SetC_BPartner_ID (0);SetC_Currency_ID (0);// @C_Currency_ID@
SetC_DocType_ID (0);// -1
SetC_PaymentTerm_ID (0);SetC_ProvisionalInvoice_ID (0);SetDocStatus (null);// DR
SetM_PriceList_ID (0);// -1
SetPosted (false);// N
...
static long serialVersionUID = 27908190104081L;/** Last Updated Timestamp 7/12/2021 4:39:47 AM */
public static long updatedMS = 1626064787292L;/** AD_Table_ID=1000551 */
...
Set_Value ("C_Project_ID", C_Project_ID);}/** Get Project.
...
throw new ArgumentException ("DocAction Invalid value - " + DocAction + " - Reference_ID=135 - -- - AP - CL - CO - IN - PO - PR - RA - RC - RE - RJ - VO - WC - XL");if (DocAction != null && DocAction.Length > 2){log.Warning("Length > 2 - truncated");DocAction = DocAction.Substring(0,2);}Set_Value ("DocAction", DocAction);}/** Get Document Action.
