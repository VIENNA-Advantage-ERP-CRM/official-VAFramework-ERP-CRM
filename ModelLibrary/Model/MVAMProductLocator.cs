...
{
    public class MVAMProductLocator : X_VAM_ProductLocator
    {
        /**
         ...
         */
        public static MVAMLocator[] GetLocators(MVAMProduct product, int VAM_Warehouse_ID)
        {
         ...
         */
        public static int GetFirstVAM_Locator_ID(MVAMProduct product, int VAM_Warehouse_ID)
        {
        ...
        /**	Logger	*/
        private static VLogger _log = VLogger.GetVLogger(typeof(MVAMProductLocator).FullName);
         ...
         *	@param trxName trx
         */
        public MVAMProductLocator(Ctx ctx, int VAM_ProductLocator_ID, Trx trxName)
         ...
         *	@param trxName trx
         */
        public MVAMProductLocator(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        ...
        public static MVAMProductLocator GetOfProductLocator(Ctx ctx, int VAM_Product_ID, int VAM_Locator_ID)
        {
            ...
            return new MVAMProductLocator(ctx, VAM_ProductLocator_ID, null);
        }
        //end
