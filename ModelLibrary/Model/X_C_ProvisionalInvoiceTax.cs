...
using System;using System.Text;using VAdvantage.DataBase;using VAdvantage.Common;using VAdvantage.Classes;using VAdvantage.Process;using VAdvantage.Model;using VAdvantage.Utility;using System.Data;/** Generated Model for C_ProvisionalInvoiceTax
 *  @author Raghu (Updated) 
 *  @version Vienna Framework 1.1.1 - $Id$ */
public class X_C_ProvisionalInvoiceTax : PO{public X_C_ProvisionalInvoiceTax (Context ctx, int C_ProvisionalInvoiceTax_ID, Trx trxName) : base (ctx, C_ProvisionalInvoiceTax_ID, trxName){/** if (C_ProvisionalInvoiceTax_ID == 0){SetC_ProvisionalInvoiceTax_ID (0);SetC_ProvisionalInvoice_ID (0);SetC_Tax_ID (0);} */
}public X_C_ProvisionalInvoiceTax (Ctx ctx, int C_ProvisionalInvoiceTax_ID, Trx trxName) : base (ctx, C_ProvisionalInvoiceTax_ID, trxName){/** if (C_ProvisionalInvoiceTax_ID == 0){SetC_ProvisionalInvoiceTax_ID (0);SetC_ProvisionalInvoice_ID (0);SetC_Tax_ID (0);} */
}/** Load Constructor 
@param ctx context
@param rs result set 
