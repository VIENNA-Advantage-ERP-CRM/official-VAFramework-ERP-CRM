    ...
    public sealed class MCloudSetup
    {
        ...
        public bool CreateAccounting(KeyNamePair currency, bool hasProduct, bool hasBPartner, bool hasProject, bool hasMCampaign, bool hasSRegion, FileStream AccountingFile)
        {
            ...
            try
            {
                ...
                {
                    int AD_Client_ID = m_client.GetAD_Client_ID();
                    DataSet ds = BaseLibrary.DataBase.DB.ExecuteDataset(sql2, null, m_trx);
        ...
        public bool CreateEntities(int C_Country_ID, String City, int C_Region_ID, int C_Currency_ID)
        {
            ...
            if (Common.Common.lstTableName.Contains("M_Product") && bp != null) // Update by Paramjeet Singh
            {
                ...
                no = BaseLibrary.DataBase.DB.ExecuteQuery(sqlCmd.ToString(), null, null);
                if (no != 1)
            ...
            {
                BaseLibrary.DataBase.DB.ExecuteQuery("UPDATE AD_LoginSetting SET M_Warehouse_ID=" + wh.GetM_Warehouse_ID() + " WHERE AD_Client_ID=" + m_client.GetAD_Client_ID(), null, m_trx);
            }
        ...
        private void CreatePreference(String Attributes, String Value, int AD_Window_ID)
        {
            ...
            int no = BaseLibrary.DataBase.DB.ExecuteQuery(sqlCmd.ToString(), null, m_trx);
            if (no != 1)
        ...
        {
            //	TODO: Exception 
            return BaseLibrary.DataBase.DB.GetNextID(AD_Client_ID, TableName, m_trx);
        }	//	GetNextID
        ...
        public void SetupPrintForm(int AD_Client_ID)
        {
            ...
            int AD_PrintForm_ID = BaseLibrary.DataBase.DB.GetNextID(AD_Client_ID, "AD_PrintForm", null);
            ...
            int no = BaseLibrary.DataBase.DB.ExecuteQuery(sql, null);
            if (no != 1)
        ...
        private void UpdatePrintFormatHeader(int Header_ID, int Line_ID)
        {
            ...
            sb.Append("UPDATE AD_PrintFormatItem SET AD_PrintFormatChild_ID=")
                ...
                .Append(Header_ID);
            BaseLibrary.DataBase.DB.ExecuteQuery(sb.ToString(), null);
