...
namespace VAdvantage.Model
{
    public class MVAMProductCostQueue : X_VAM_ProductCostQueue
    {
        ...
        /// <param name="trxName">transaction</param>
        public MVAMProductCostQueue(MVAMProduct product, int VAM_PFeature_SetInstance_ID,
        ...
        public static MVAMProductCostQueue Get(MVAMProduct product, int VAM_PFeature_SetInstance_ID,
            MVABAccountBook mas, int VAF_Org_ID, int VAM_ProductCostElement_ID, Trx trxName)
        {
        ...
        /// <param name="trxName">transaction</param>
        /// <returns>cost queue or null</returns>
        public static MVAMProductCostQueue[] GetQueue(MVAMProduct product, int M_ASI_ID, MVABAccountBook mas,
                            ...
                            if (cd.GetVAB_OrderLine_ID() == 0)
                            {
                                ...
                                if ((optionalstr == "window" && (costingMethodMatchPO == "A" || inoutline.IsCostCalculated())) || optionalstr == "process")
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            MVAMCostElementDetail.CreateCostElementDetail(ctx, VAF_Client_ID, VAF_Org_ID, product, 0,
                                        ...
                                        {
                                            MVAMCostElementDetail.CreateCostElementDetail(ctx, VAF_Client_ID, VAF_Org_ID, product, M_ASI_ID,
                                                                     acctSchema, costElementId, windowName, cd, Decimal.Round(Decimal.Multiply(cost.GetCurrentCostPrice(), Qty), acctSchema.GetCostingPrecision()), Qty);
                                        }
                                    }
                                    #endregion
