...
{
    public class MVAMProduct : X_VAM_Product
    {
        //	UOM Precision			
        private int? _precision = null;
        // Additional Downloads				
        private MVAMProductDownload[] _downloads = null;
        //	Cache						
        private static CCache<int, MVAMProduct> s_cache = new CCache<int, MVAMProduct>("VAM_Product", 40, 5);	//	5 minutes
        //	Static Logger	*
        private static VLogger _log = VLogger.GetVLogger(typeof(MVAMProduct).FullName);

        /// <summary>
        /// Get MVAMProduct from Cache
        /// </summary>
        /// <param name="ctx">context</param>
        /// <param name="VAM_Product_ID">id</param>
        /// <returns>MVAMProduct</returns>
        public static MVAMProduct Get(Ctx ctx, int VAM_Product_ID)
        {
            int key = VAM_Product_ID;
            MVAMProduct retValue = (MVAMProduct)s_cache[key];
            if (retValue != null)
                return retValue;
            retValue = new MVAMProduct(ctx, VAM_Product_ID, null);
        ...
        *	@return MVAMProduct
        */
        public static MVAMProduct[] Get(Ctx ctx, String whereClause, Trx trxName)
        {
            ...
            try
            {
                ...
                {
                    list.Add(new MVAMProduct(ctx, dr, trxName));
                }
            }
            catch (Exception e)
            {
            ...
            MVAMProduct[] retValue = new MVAMProduct[list.Count];
        ...
        public static MVAMProduct GetTrial(Ctx ctx, String entityType)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    retValue = new MVAMProduct(ctx, dr, null);
                }
                ds = null;
            }
            catch (Exception e)
        ...
        */
        ...
        {
            MVAMProduct product = Get(ctx, VAM_Product_ID);
         ...
         */
        public MVAMProduct(Ctx ctx, int VAM_Product_ID, Trx trxName)
         ...
         *	@param trxName transaction
         */
        public MVAMProduct(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
         ...
         *	@param et parent
         */
        public MVAMProduct(MVASChargeType et)
         ...
         */
        public MVAMProduct(MVASResource resource, MVASResType resourceType)
        ...
        */
         ...
         *	@return true if changed
         */
        public bool SetResource(MVASResource parent)
        {
            bool changed = false;
         ...
         *	@return true if changed
         */
        public bool SetResource(MVASResType parent)
        {
            bool changed = false;
            if (PRODUCTTYPE_Resource.Equals(GetProductType()))
            {
       ...
       */
        ...
        */
        ...
        {
            MVAMProductCategory pc = MVAMProductCategory.Get(GetCtx(), GetVAM_ProductCategory_ID());
        ...
        */
        public MVAMProductDownload[] GetProductDownloads(bool requery)
        {
            if (_downloads != null && !requery)
                return _downloads;
            //
            List<MVAMProductDownload> list = new List<MVAMProductDownload>();
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    list.Add(new MVAMProductDownload(GetCtx(), dr, Get_TrxName()));
                }
            ...
            _downloads = new MVAMProductDownload[list.Count];
        ...
        */
        ...
        {
            StringBuilder sb = new StringBuilder("MVAMProduct[");
        ...
        protected override bool BeforeSave(bool newRecord)
        {
            ...
            {
                MVAMStorage[] storages = MVAMStorage.GetOfProduct(GetCtx(), Get_ID(), Get_TrxName());
        ...
        protected override bool AfterSave(bool newRecord, bool success)
        {
            ...
            if (count > 0)
            {
                ...
                int _MVAMProduct_ID = GetVAM_Product_ID();
                ...
                _sql.Clear();
                _sql.Append("Select Count(*) From FRPT_Product_Acct  where VAM_Product_ID=" + _MVAMProduct_ID + " AND IsActive = 'Y' AND VAF_Client_ID = " + GetVAF_Client_ID());
                ...
                if (value < 1)
                {
                    ...
                    if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                    {
                        for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                        {
                            ...
                            obj.Set_ValueNoCheck("VAM_Product_ID", _MVAMProduct_ID);
      ...
      "WHERE IsActive='Y'  AND VAM_Product_ID=" + GetVAM_Product_ID();
                ...
                if (newRecord)
                {
                    ...
                    {
                        //	Old
                        MVAMProductCosting pcOld = new MVAMProductCosting(this, mass[i].GetVAB_AccountBook_ID());
                        pcOld.Save();
                    }
                }
                //	New Costing
                ...
                //{
                //    MVAMVAMProductCost.Create(this);
                //}
            }
            ...
            //if (newRecord || Is_ValueChanged("VAM_ProductCategory_ID"))
            //{
            //    MVAMVAMProductCost.CreateRecords(this);
            //}
            //20-12-2016
        ...
        protected override bool BeforeDelete()
        {
            ...
            //	delete costing           
            MVAMProductCosting[] costings = MVAMProductCosting.GetOfProduct(GetCtx(), Get_ID(), Get_TrxName());
