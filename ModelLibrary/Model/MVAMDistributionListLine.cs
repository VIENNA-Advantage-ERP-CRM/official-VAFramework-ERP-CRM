 ...
 * Class Name     : MVAMDistributionListLine
...
{
    public class MVAMDistributionListLine : X_VAM_DistributionListLine
    {
        /// <summary>
        ...
        public MVAMDistributionListLine(Ctx ctx, int VAM_DistributionListLine_ID, Trx trxName)
        ...
        /// <param name="dr"></param>
        /// <param name="trxName">transaction</param>
        public MVAMDistributionListLine(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
