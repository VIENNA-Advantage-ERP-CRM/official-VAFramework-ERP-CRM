...
namespace VAdvantage.Model
{
    ...
    /// </summary>
    public class MVABWorkCommissionLine : X_VAB_WorkCommissionLine
    {
        /// <summary>
        ...
        public MVABWorkCommissionLine(Ctx ctx, int VAB_WorkCommissionLine_ID, Trx trxName)
        ...
        /// <param name="trxName">transaction</param>
        public MVABWorkCommissionLine(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }
    }
