...
public void SetRef_InvoiceLine_ID (int Ref_InvoiceLine_ID){if (Ref_InvoiceLine_ID <= 0) Set_Value ("Ref_InvoiceLine_ID", null);else
Set_Value ("Ref_InvoiceLine_ID", Ref_InvoiceLine_ID);}/** Get Referenced Invoice Line.
...
public void SetRef_Invoice_ID (int Ref_Invoice_ID){if (Ref_Invoice_ID <= 0) Set_Value ("Ref_Invoice_ID", null);else
Set_Value ("Ref_Invoice_ID", Ref_Invoice_ID);}/** Get Referenced Invoice.
