...
{
    public class MVAMReturnRule : X_VAM_ReturnRule
    {

        private static VLogger s_log = VLogger.GetVLogger(typeof(MVAMReturnRule).FullName);
        ...
        public MVAMReturnRule(Ctx ctx, int VAM_ReturnRule_ID, Trx trxName)
        ...
        /// <param name="trxName">transaction</param>
        public MVAMReturnRule(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        ...
        public bool CheckReturnPolicy(DateTime? shipDate, DateTime? returnDate, int VAM_Product_ID)
        {
            ...
            {
                MVAMProduct product = new MVAMProduct(GetCtx(), VAM_Product_ID, Get_TrxName());
            ...
            {
                MVAMReturnRuleLine rpolicyLine = new MVAMReturnRuleLine(GetCtx(), VAM_ReturnRuleLine_ID, Get_TrxName());
