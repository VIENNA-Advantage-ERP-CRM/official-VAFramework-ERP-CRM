...
{
    class MVABBankAcctDoc : X_VAB_Bank_AcctDoc
    {
        public MVABBankAcctDoc(Ctx ctx, int VAB_Bank_Acct_ID, Trx trxName)
            : base(ctx, VAB_Bank_Acct_ID, trxName)
        {
        }

        public MVABBankAcctDoc(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }
