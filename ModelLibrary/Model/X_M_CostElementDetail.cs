...
using System;using System.Text;using VAdvantage.DataBase;using VAdvantage.Common;using VAdvantage.Classes;using VAdvantage.Process;using VAdvantage.Model;using VAdvantage.Utility;using System.Data;/** Generated Model for M_CostElementDetail
 *  @author Raghu (Updated) 
 *  @version Vienna Framework 1.1.1 - $Id$ */
public class X_M_CostElementDetail : PO{public X_M_CostElementDetail (Context ctx, int M_CostElementDetail_ID, Trx trxName) : base (ctx, M_CostElementDetail_ID, trxName){/** if (M_CostElementDetail_ID == 0){SetAmt (0.0);SetC_AcctSchema_ID (0);SetM_CostElementDetail_ID (0);SetM_CostElement_ID (0);SetM_Product_ID (0);SetQty (0.0);} */
}public X_M_CostElementDetail (Ctx ctx, int M_CostElementDetail_ID, Trx trxName) : base (ctx, M_CostElementDetail_ID, trxName){/** if (M_CostElementDetail_ID == 0){SetAmt (0.0);SetC_AcctSchema_ID (0);SetM_CostElementDetail_ID (0);SetM_CostElement_ID (0);SetM_Product_ID (0);SetQty (0.0);} */
}/** Load Constructor 
@param ctx context
@param rs result set 
...
public void SetA_Asset_ID (int A_Asset_ID){if (A_Asset_ID <= 0) Set_Value ("A_Asset_ID", null);else
Set_Value ("A_Asset_ID", A_Asset_ID);}/** Get Asset.
...
public void SetC_InvoiceLine_ID (int C_InvoiceLine_ID){if (C_InvoiceLine_ID <= 0) Set_Value ("C_InvoiceLine_ID", null);else
Set_Value ("C_InvoiceLine_ID", C_InvoiceLine_ID);}/** Get Invoice Line.
...
public void SetC_OrderLine_ID (int C_OrderLine_ID){if (C_OrderLine_ID <= 0) Set_Value ("C_OrderLine_ID", null);else
Set_Value ("C_OrderLine_ID", C_OrderLine_ID);}/** Get Order Line.
@return Order Line */
...
public void SetM_WorkOrderResourceTxnLine_ID (int M_WorkOrderResourceTxnLine_ID){if (M_WorkOrderResourceTxnLine_ID <= 0) Set_Value ("M_WorkOrderResourceTxnLine_ID", null);else
Set_Value ("M_WorkOrderResourceTxnLine_ID", M_WorkOrderResourceTxnLine_ID);}/** Get Work Order Resource Transaction Line.
...
public void SetM_WorkOrderTransactionLine_ID (int M_WorkOrderTransactionLine_ID){if (M_WorkOrderTransactionLine_ID <= 0) Set_Value ("M_WorkOrderTransactionLine_ID", null);else
Set_Value ("M_WorkOrderTransactionLine_ID", M_WorkOrderTransactionLine_ID);}/** Get Work Order Transaction Line.
