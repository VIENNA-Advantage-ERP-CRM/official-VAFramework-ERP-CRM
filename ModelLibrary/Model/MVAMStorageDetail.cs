...
{
    public class MVAMStorageDetail : X_VAM_StorageDetail
    {
        #region Private Variables
        // Logger for class MVAMStorageDetail 
        private static VLogger s_log = VLogger.GetVLogger(typeof(MVAMStorageDetail).FullName);
        ...
        public MVAMStorageDetail(MVAMLocator locator, int VAM_Product_ID,
        ...
        public MVAMStorageDetail(Ctx ctx, int VAM_Locator_ID, int VAM_Product_ID,
        ...
        private MVAMStorageDetail(Ctx ctx, int VAM_StorageDetail_ID, Trx trx)
        ...
        public MVAMStorageDetail(Ctx ctx, DataRow dr, Trx trx)
            : base(ctx, dr, trx)
        {
                ...
                )
            {
                ...
                if (wh.IsDisallowNegativeInv())
                {
                    ...
                    if (IsType(X_Ref_Quantity_Type.ON_HAND))
                    {
                        ...
                        asiQtyOnHand = GetQty();
                        asiQtyAllocated = MVAMStorageDetail.GetQty(GetCtx(), GetVAM_Locator_ID(), GetVAM_Product_ID(), GetVAM_PFeature_SetInstance_ID(), X_Ref_Quantity_Type.ALLOCATED, Get_TrxName());
                        asiQtyDedicated = MVAMStorageDetail.GetQty(GetCtx(), GetVAM_Locator_ID(), GetVAM_Product_ID(), GetVAM_PFeature_SetInstance_ID(), X_Ref_Quantity_Type.DEDICATED, Get_TrxName());
                    }
                    else if (IsType(X_Ref_Quantity_Type.DEDICATED))
                    {
                        ...
                        asiQtyOnHand = MVAMStorageDetail.GetQty(GetCtx(), GetVAM_Locator_ID(), GetVAM_Product_ID(), GetVAM_PFeature_SetInstance_ID(), X_Ref_Quantity_Type.ON_HAND, Get_TrxName());
                        asiQtyAllocated = MVAMStorageDetail.GetQty(GetCtx(), GetVAM_Locator_ID(), GetVAM_Product_ID(), GetVAM_PFeature_SetInstance_ID(), X_Ref_Quantity_Type.ALLOCATED, Get_TrxName());
        ...
        /// <param name="trx"></param>
        /// <returns></returns>
        public static MVAMStorageDetail GetForRead(Ctx ctx, int VAM_Locator_ID,
        ...
        public static MVAMStorageDetail GetForUpdate(Ctx ctx, int VAM_Locator_ID,
                int VAM_Product_ID, int VAM_PFeature_SetInstance_ID,
                String type, Trx trx)
        {
            return Get(ctx, VAM_Locator_ID, VAM_Product_ID, VAM_PFeature_SetInstance_ID,
        ...
        private static MVAMStorageDetail Get(Ctx ctx, int VAM_Locator_ID,
                int VAM_Product_ID, int VAM_PFeature_SetInstance_ID,
                String type, Boolean forUpdate, Trx trx)
        {
            MVAMStorageDetail retValue = null;
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    retValue = new MVAMStorageDetail(ctx, dt.Rows[0], trx);
                }
            }
            catch (Exception ex)
            {
        ...
        //Collection
        public static List<MVAMStorageDetail> GetMultipleForUpdate(Ctx ctx, int VAM_Locator_ID,
                int VAM_Product_ID, int VAM_PFeature_SetInstance_ID,
                List<String> types, Trx trx)
        {
            return GetMultiple(ctx, VAM_Locator_ID, VAM_Product_ID, VAM_PFeature_SetInstance_ID, types, true, trx);
        }
        public static List<MVAMStorageDetail> GetMultipleForRead(Ctx ctx, int VAM_Locator_ID,
                int VAM_Product_ID, int VAM_PFeature_SetInstance_ID,
                List<String> types, Trx trx)
        {
        ...
        private static List<MVAMStorageDetail> GetMultiple(Ctx ctx, int VAM_Locator_ID,
                int VAM_Product_ID, int VAM_PFeature_SetInstance_ID,
                List<String> types, Boolean forUpdate, Trx trx)
        {
            List<MVAMStorageDetail> retValue = new List<MVAMStorageDetail>();
            ...
            try
            {
                ...
                {
                    retValue.Add(new MVAMStorageDetail(ctx, dr, trx));
                }
            }
            catch (Exception ex)
            {
        ...
        public static MVAMStorageDetail GetCreate(Ctx ctx, int VAM_Locator_ID,
                int VAM_Product_ID, int VAM_PFeature_SetInstance_ID, String type, Trx trx)
        {
            ...
            MVAMStorageDetail retValue = GetForUpdate(ctx, VAM_Locator_ID, VAM_Product_ID,
            ...
            //
            retValue = new MVAMStorageDetail(locator, VAM_Product_ID,
        ...
        /// <param name="trx"></param>
        /// <returns></returns>
        public static List<MVAMStorageDetail> GetAll(Ctx ctx, int VAM_Product_ID,
                int VAM_Locator_ID, X_Ref_Quantity_Type qtyType, Boolean isFIFO,
                Boolean withASI, Trx trx)
        {
            List<MVAMStorageDetail> list = new List<MVAMStorageDetail>();
            String sql = "select s.* "
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    list.Add(new MVAMStorageDetail(ctx, dr, trx));
                }
            }
            catch (Exception ex)
            {
        ...
        /*  public static Map<X_Ref_Quantity_Type, MVAMStorageDetail> getAllForUpdate(
		...
		Map<X_Ref_Quantity_Type, MVAMStorageDetail> storageDetails = new HashMap<X_Ref_Quantity_Type, MVAMStorageDetail>();
		for (X_Ref_Quantity_Type qtyType : X_Ref_Quantity_Type.values()) {
			MVAMStorageDetail store = MVAMStorageDetail.Get(ctx, VAM_Locator_ID,
        ...
        public static Dictionary<String, MVAMStorageDetail> GetAllForUpdate(Ctx ctx, int VAM_Locator_ID, int VAM_Product_ID,
                int VAM_PFeature_SetInstance_ID, List<String> updateQtyTypes, Trx trx)
        {
            Dictionary<String, MVAMStorageDetail> storageDetails = new Dictionary<String, MVAMStorageDetail>();
                ...
                String type, Trx trx)
        {
            ...
            MVAMStorageDetail storage = null;
            storage = MVAMStorageDetail.GetCreate(ctx, VAM_Locator_ID, VAM_Product_ID,
                    VAM_PFeature_SetInstance_ID, type, trx);
            // Verify
            ...
            MVAMStorageDetail storageASI = null;
