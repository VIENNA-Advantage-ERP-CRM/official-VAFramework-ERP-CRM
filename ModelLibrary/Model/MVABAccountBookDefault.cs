 ...
 * Class Used     : X_VAB_AccountBook_Default
...
{
    public class MVABAccountBookDefault : X_VAB_AccountBook_Default
    {
        /**	Logger							*/
        protected static VLogger _log = VLogger.GetVLogger(typeof(MVABAccountBookDefault).FullName);
        ...
        public static MVABAccountBookDefault Get(Ctx ctx, int VAB_AccountBook_ID)
        {
            MVABAccountBookDefault retValue = null;
            String sql = "SELECT * FROM VAB_AccountBook_Default WHERE VAB_AccountBook_ID=@Param1";
            ...
            try
            {
                ...
                {
                    retValue = new MVABAccountBookDefault(ctx, dr, null);
                }
            }
            catch (Exception e)
            {
        ...
        /// </summary>
        /// <param name="ctx">context</param>
        /// <param name="VAB_AccountBook_ID">parent</param>
        /// <param name="trxName">transaction</param>
        public MVABAccountBookDefault(Ctx ctx, int VAB_AccountBook_ID, Trx trxName)
        ...
        /// <param name="trxName">transaction</param>
        public MVABAccountBookDefault(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        ...
        public int GetRealizedGain_Acct(int VAB_Currency_ID)
        {
            MVABCurrencyAcct acct = MVABCurrencyAcct.Get(this, VAB_Currency_ID);
            if (acct != null)
            {
        ...
        public int GetRealizedLoss_Acct(int VAB_Currency_ID)
        {
            MVABCurrencyAcct acct = MVABCurrencyAcct.Get(this, VAB_Currency_ID);
            if (acct != null)
            {
