...
{
    public class MVAFAlertSetting : X_VAF_AlertSetting
    {
        public MVAFAlertSetting(Ctx ctx, int VAF_AlertSetting_ID, Trx trx)
        ...
        public MVAFAlertSetting(Ctx ctx, DataRow rs, Trx trx)
            : base(ctx, rs, trx)
        {
        ...
        {
            StringBuilder sb = new StringBuilder("MVAFAlertSetting[");
            sb.Append(Get_ID())
