 ...
 * Class Name     : MVAMDistributionRunLine
...
{
    public class MVAMDistributionRunLine : X_VAM_DistributionRunLine
    {
        ...
        public MVAMDistributionRunLine(Ctx ctx, int VAM_DistributionRunLine_ID, Trx trxName)
        ...
        public MVAMDistributionRunLine(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        ...
        {
            StringBuilder sb = new StringBuilder("MVAMDistributionRunLine[")
