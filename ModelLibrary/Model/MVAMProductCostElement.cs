...
{
    public class MVAMVAMProductCostElement : X_VAM_ProductCostElement
    {
        //Cache					
        private static CCache<int, MVAMVAMProductCostElement> s_cache = new CCache<int, MVAMVAMProductCostElement>("VAM_ProductCostElement", 20);

        /**	Logger	*/
        private static VLogger _log = VLogger.GetVLogger(typeof(MVAMVAMProductCostElement).FullName);
         ...
         *	@return cost element
         */
        public static MVAMVAMProductCostElement GetMaterialCostElement(PO po, String CostingMethod)
        {
            ...
            //
            MVAMVAMProductCostElement retValue = null;
            ...
            try
            {
                ...
                {
                    retValue = new MVAMVAMProductCostElement(po.GetCtx(), dr, po.Get_TrxName());
                }
                //if (n && dr.next())
            ...
            //	Create New
            retValue = new MVAMVAMProductCostElement(po.GetCtx(), 0, po.Get_TrxName());
         ...
         */
        public static MVAMVAMProductCostElement GetMaterialCostElement(Ctx ctx, String CostingMethod)
        {
            MVAMVAMProductCostElement retValue = null;
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    retValue = new MVAMVAMProductCostElement(ctx, dr, null);
                }
                //if (dr.next())
         ...
         */
        public static MVAMVAMProductCostElement[] GetCostingMethods(PO po)
        {
            List<MVAMVAMProductCostElement> list = new List<MVAMVAMProductCostElement>();
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    list.Add(new MVAMVAMProductCostElement(po.GetCtx(), dr, po.Get_TrxName()));
                }
            }
            catch (Exception e)
            {
            ...
            MVAMVAMProductCostElement[] retValue = new MVAMVAMProductCostElement[list.Count];
        ...
        public static MVAMVAMProductCostElement[] GetMaterialCostingMethods(PO po)
        {
            List<MVAMVAMProductCostElement> list = new List<MVAMVAMProductCostElement>();
            String sql = "SELECT * FROM VAM_ProductCostElement "
                + "WHERE VAF_Client_ID=@Client_ID"
         ...
         *	@return Cost Element
         */
        public static MVAMVAMProductCostElement Get(Ctx ctx, int VAM_ProductCostElement_ID)
        {
            int key = VAM_ProductCostElement_ID;
            MVAMVAMProductCostElement retValue = (MVAMVAMProductCostElement)s_cache[key];
            if (retValue != null)
                return retValue;
            retValue = new MVAMVAMProductCostElement(ctx, VAM_ProductCostElement_ID, null);
         ...
         *	@param trxName trx
         */
        public MVAMVAMProductCostElement(Ctx ctx, int VAM_ProductCostElement_ID, Trx trxName)
         ...
         *	@param trxName trx
         */
        public MVAMVAMProductCostElement(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
