 ...
 * Class Name     : MVAMRequisitionLine
 * Purpose        : 
 * Class Used     : 
...
{
    public class MVAMRequisitionLine : X_VAM_RequisitionLine
    {
        // Parent					
        private MVAMRequisition _parent = null;
        //	PriceList				
         ...
         */
        public MVAMRequisitionLine(Ctx ctx, int VAM_RequisitionLine_ID, Trx trxName)
            : base(ctx, VAM_RequisitionLine_ID, trxName)
        {
            ...
            {
                log.Warning("MVAMRequisitionLine--Standard Constructor" + e.Message);
            }
         ...
         *	@param trxName transaction
         */
        public MVAMRequisitionLine(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
         ...
         *	@param trxName transaction
         */
        public MVAMRequisitionLine(Ctx ctx, IDataReader dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
         ...
         */
        public MVAMRequisitionLine(MVAMRequisition req)
         ...
         *	@return parent
         */
        public MVAMRequisition GetParent()
        {
            try
            {
                if (_parent == null)
                {
                    _parent = new MVAMRequisition(GetCtx(), GetVAM_Requisition_ID(), Get_TrxName());
                }
            }
            catch
            {
        ...
        public void SetPrice(int VAM_PriceList_ID)
        {
            ...
            {
               // MessageBox.Show("MVAMRequisitionLine--SetPrice(int VAM_PriceList_ID)");
            }
        }
