...
{
    public class MVABCurrency : X_VAB_Currency
    {
        //Store System Currencies			
        private static CCache<int, MVABCurrency> currencies = new CCache<int, MVABCurrency>("VAB_Currency", 50);
        ...
        public MVABCurrency(Ctx ctx, int VAB_Currency_ID, Trx trxName)
        ...
        /// <param name="trxName">transaction</param>
        public MVABCurrency(Ctx ctx, string ISO_Code,
        ...
        /// <param name="trxName">transaction</param>
        public MVABCurrency(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }
        ...
        public static MVABCurrency Get(Ctx ctx, int VAB_Currency_ID)
        {
            //	Try Cache
            int key = VAB_Currency_ID;
            MVABCurrency retValue = currencies[key];
            if (retValue != null)
                return retValue;
            //	Create it
            retValue = new MVABCurrency(ctx, VAB_Currency_ID, null);
            //	Save in System
        ...
        public static string GetISO_Code(Ctx ctx, int VAB_Currency_ID)
        {
            ...
            //	Create it
            MVABCurrency c = Get(ctx, VAB_Currency_ID);
