...
namespace VAdvantage.Model
{
    public class MVAMProductionLine : X_VAM_ProductionLine
    {
        ...
        public MVAMProductionLine(Ctx ctx, int VAM_ProductionLine_ID, Trx trxName)
        ...
        /// <param name="dr"></param>
        /// <param name="trxName"></param>
        public MVAMProductionLine(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
