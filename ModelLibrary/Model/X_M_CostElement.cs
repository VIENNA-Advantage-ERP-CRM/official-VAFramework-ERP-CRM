...
/** Cost Combination = C */
public static String COSTINGMETHOD_CostCombination = "C";
/** Fifo = F */
...
/** Weighted Average PO = O */
public static String COSTINGMETHOD_WeightedAveragePO = "O";
/** Standard Costing = S */
public static String COSTINGMETHOD_StandardCosting = "S";
/** User Defined = U */
public static String COSTINGMETHOD_UserDefined = "U";
/** Weighted Average Cost = W */
public static String COSTINGMETHOD_WeightedAverageCost = "W";
/** Last Invoice = i */
...
{
    return test == null || test.Equals("A") || test.Equals("C") || test.Equals("F") || test.Equals("I") || test.Equals("L") || test.Equals("O") || test.Equals("S") || test.Equals("U") || test.Equals("W") || test.Equals("i") || test.Equals("p") || test.Equals("x");
}
/** Set Costing Method.
...
if (!IsCostingMethodValid(CostingMethod))
    throw new ArgumentException("CostingMethod Invalid value - " + CostingMethod + " - Reference_ID=122 - A - C - F - I - L - O - S - U - W  - i - p - x");
