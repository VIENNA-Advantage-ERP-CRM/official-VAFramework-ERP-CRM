...
using System;using System.Text;using VAdvantage.DataBase;using VAdvantage.Common;using VAdvantage.Classes;using VAdvantage.Process;using VAdvantage.Model;using VAdvantage.Utility;using System.Data;/** Generated Model for C_ProvisionalInvoiceLine
 *  @author Raghu (Updated) 
 *  @version Vienna Framework 1.1.1 - $Id$ */
public class X_C_ProvisionalInvoiceLine : PO{public X_C_ProvisionalInvoiceLine (Context ctx, int C_ProvisionalInvoiceLine_ID, Trx trxName) : base (ctx, C_ProvisionalInvoiceLine_ID, trxName){/** if (C_ProvisionalInvoiceLine_ID == 0){SetC_ProvisionalInvoiceLine_ID (0);SetC_ProvisionalInvoice_ID (0);SetLine (0);// @SQL=SELECT NVL(MAX(Line),0)+10 AS DefaultValue FROM C_ProvisionalInvoiceLine WHERE C_ProvisionalInvoice_ID=@C_ProvisionalInvoice_ID@
} */
}public X_C_ProvisionalInvoiceLine (Ctx ctx, int C_ProvisionalInvoiceLine_ID, Trx trxName) : base (ctx, C_ProvisionalInvoiceLine_ID, trxName){/** if (C_ProvisionalInvoiceLine_ID == 0){SetC_ProvisionalInvoiceLine_ID (0);SetC_ProvisionalInvoice_ID (0);SetLine (0);// @SQL=SELECT NVL(MAX(Line),0)+10 AS DefaultValue FROM C_ProvisionalInvoiceLine WHERE C_ProvisionalInvoice_ID=@C_ProvisionalInvoice_ID@
} */
}/** Load Constructor 
@param ctx context
@param rs result set 
...
static long serialVersionUID = 27908190097568L;/** Last Updated Timestamp 7/12/2021 4:39:40 AM */
public static long updatedMS = 1626064780779L;/** AD_Table_ID=1000552 */
...
public Decimal GetQtyInvoiced() {Object bd =Get_Value("QtyInvoiced");if (bd == null) return Env.ZERO;return  Convert.ToDecimal(bd);}/** Set Tax Amount.
