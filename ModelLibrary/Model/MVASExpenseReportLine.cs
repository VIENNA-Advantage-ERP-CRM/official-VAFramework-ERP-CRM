 ...
 * Class Name     : MVASExpenseReportLine
...
{
    public class MVASExpenseReportLine : X_VAS_ExpenseReportLine
    {
        /// <summary>
        ...
        public MVASExpenseReportLine(Ctx ctx, int VAS_ExpenseReportLine_ID, Trx trxName)
        ...
        /// <param name="trxName">transaction</param>
        public MVASExpenseReportLine(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        ...
        public int GetVAB_Currency_Report_ID()
        {
            ...
            //	Get it from header
            MVASExpenseReport te = new MVASExpenseReport(GetCtx(), GetVAS_ExpenseReport_ID(), Get_TrxName());
                ...
                String newVAM_Product_ID, int windowNo)
        {
            ...
            //	Employee
            MVASExpenseReport hdr = new MVASExpenseReport(GetCtx(), GetVAS_ExpenseReport_ID(), null);
                ...
                if (newRecord || Is_ValueChanged("VAS_Res_Assignment_ID"))
                {
                    ...
                    if (!newRecord)
                    {
                        ...
                        if (ii is int)
                        {
                            ...
                            {
                                MVASResAssignment ra = new MVASResAssignment(GetCtx(),
