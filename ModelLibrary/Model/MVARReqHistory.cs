...
{
    public class MVARReqHistory : X_VAR_Req_History
    {
        /**
	     ...
	     */
        public MVARReqHistory(Ctx ctx, int VAR_Req_History_ID, Trx trxName) :
         ...
         *	@param rs result set
         */
        public MVARReqHistory(Ctx ctx, DataRow dr, Trx trxName) :
            base(ctx, dr, trxName)
        {
        }
         ...
         */
        public MVARReqHistory(MVARRequest request, bool newRecord)
