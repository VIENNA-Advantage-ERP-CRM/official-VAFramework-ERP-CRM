...
{
    public class MVABAccountBookGL : X_VAB_AccountBook_GL
    {
        /**	Logger							*/
	protected static VLogger			_log = VLogger.GetVLogger(typeof(MVABAccountBookGL).FullName);
    /// <summary>
	...
	public static MVABAccountBookGL Get(Ctx ctx, int VAB_AccountBook_ID)
	{
		MVABAccountBookGL retValue = null;
		...
		try 
		{
			...
			{
				retValue = new MVABAccountBookGL (ctx, dr, null);
			}
	...
	public MVABAccountBookGL (Ctx ctx, int VAB_AccountBook_ID, Trx trxName):base(ctx, VAB_AccountBook_ID, trxName)
	{
    ...
    /// <param name="trxName">transaction</param>
	public MVABAccountBookGL(Ctx ctx,DataRow dr, Trx trxName):base(ctx, dr, trxName)
	{
