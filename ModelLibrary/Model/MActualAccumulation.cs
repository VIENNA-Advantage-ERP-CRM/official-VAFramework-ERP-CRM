...
namespace VAdvantage.Model
{
    ...
    public class MActualAccumulation : X_Actual_Accumulation
    {
        #region Private Variables
        /** Logger for class MActualAccumulation */
        private static VLogger s_log = VLogger.GetVLogger(typeof(MActualAccumulation).FullName);
        /**	Logger	*/
     ...
     */
        public static List<MActualAccumulation> GetAll(Ctx ctx, int VAB_AccountBook_ID)
        {
            ...
            List<MActualAccumulation> list = new List<MActualAccumulation>();
            ...
            try
            {
                ...
                {
                    list.Add(new MActualAccumulation(ctx, dr, null));
                }
            }
            catch (Exception e)
            {
         ...
         *	@return dateFrom
         */
        public static DateTime? GetDateFrom(MActualAccumulation accum, DateTime? dateFrom)
        {
         ...
         *	@param trx p_trx
         */
        public MActualAccumulation(Ctx ctx, int Actual_Accumulation_ID, Trx trx)
         ...
         *	@param trx p_trx
         */
        public MActualAccumulation(Ctx ctx, DataRow dr, Trx trx)
            : base(ctx, dr, trx)
        {
        ...
        {
            StringBuilder sb = new StringBuilder("MActualAccumulation[")
                .Append(Get_ID())
