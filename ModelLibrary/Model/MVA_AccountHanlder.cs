...
{
    public class MVA_AccountHanlder : X_VAB_AccountHanlder, ViennaProcessor
    {
        //Static Logger	
        private static VLogger _log = VLogger.GetVLogger(typeof(MVA_AccountHanlder).FullName);
        ...
        public static MVA_AccountHanlder[] GetActive(Ctx ctx)
        {
            List<MVA_AccountHanlder> list = new List<MVA_AccountHanlder>();
               ...
               idr = DataBase.DB.ExecuteReader(sql, null, null);
                while (idr.Read())
                {
                    ...
                    //list.Add(new MAcctProcessor(ctx, idr, null));
                      ...
                      {
                          list.Add(new MVA_AccountHanlder(new Ctx(), idr, null));
                      }
            ...
            MVA_AccountHanlder[] retValue = new MVA_AccountHanlder[list.Count];
        ...
        public MVA_AccountHanlder(Ctx ctx, int VAB_AccountHanlder_ID, Trx trxName)
        ...
        /// <param name="trxName"></param>
        public MVA_AccountHanlder(Ctx ctx, IDataReader idr, Trx trxName)
        ...
        public MVA_AccountHanlder(MVAFClient client, int Supervisor_ID)
