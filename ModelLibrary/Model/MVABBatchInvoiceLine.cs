 ...
 * Class Name     : MVABBatchInvoiceLine
...
{
    public class MVABBatchInvoiceLine : X_VAB_BatchInvoiceLine
    {
        /**
	 ...
	 *	@param trxName trx
	 */
        public MVABBatchInvoiceLine(Ctx ctx, int VAB_BatchInvoiceLine_ID,
            Trx trxName) :
         ...
         *	@param trxName trx
         */
        public MVABBatchInvoiceLine(Ctx ctx, DataRow dr, Trx trxName) :
            base(ctx, dr, trxName)
        {
        }
        ...
        private void SetDocumentNo()
        {
            ...
            if (VAB_BatchInvoiceLine_ID == 0)
                return;
            MVABBatchInvoiceLine last = new MVABBatchInvoiceLine(GetCtx(), VAB_BatchInvoiceLine_ID, null);
