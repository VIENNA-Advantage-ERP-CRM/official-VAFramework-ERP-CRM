/********************************************************
 * Class Name     : MVAGLAssignAcctSchema
...
{
    public class MVAGLAssignAcctSchema : X_VAGL_AssignAcctSchema
    {
        /// <summary>
        ...
        public MVAGLAssignAcctSchema(Ctx ctx, int VAGL_AssignAcctSchema_ID, Trx trxName)
        ...
        /// <param name="trxName">transaction</param>
        public MVAGLAssignAcctSchema(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        ...
        public static MVAGLAssignAcctSchema GetOrCreate(Ctx ctx, int VAGL_JRNL_ID, int VAB_AccountBook_ID, Trx trxName)
        {
            MVAGLAssignAcctSchema retValue = null;
            ...
            retValue = new MVAGLAssignAcctSchema(ctx, recordId, trxName);
            return retValue;
        }
