...
{
    public class MVABBankingJRNLLoader : X_VAB_BankingJRNLLoader
    {
        ...
        public MVABBankingJRNLLoader(Ctx ctx, int VAB_BankingJRNLLoader_ID, Trx trxName)
        ...
        /// <param name="VAB_BankingJRNLLoader_ID">loader to use</param>
        /// <param name="trxName">trx</param>
        public MVABBankingJRNLLoader(Ctx ctx, int VAB_BankingJRNLLoader_ID, String fileName, Trx trxName)
            : base(ctx, VAB_BankingJRNLLoader_ID, trxName)
        {
        ...
        public MVABBankingJRNLLoader(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
