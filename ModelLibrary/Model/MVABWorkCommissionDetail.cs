...
namespace VAdvantage.Model
{
    ...
    /// </summary>
    public class MVABWorkCommissionDetail : X_VAB_WorkCommissionDetail
    {
        /// <summary>
        ...
        public MVABWorkCommissionDetail(Ctx ctx, int ignored, Trx trxName)
            : base(ctx, 0, trxName)
        {
            if (ignored != 0)
        ...
        /// <param name="trxName">transaction</param>
        public MVABWorkCommissionDetail(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }
        ...
        public MVABWorkCommissionDetail(MVABWorkCommissionAmt camt, int VAB_Currency_ID, Decimal amt, Decimal qty)
        ...
        public void SetLineIDs(int VAB_OrderLine_ID, int VAB_InvoiceLine_ID)
        {
        ...
        {
            Decimal amt = MVABExchangeRate.ConvertBase(GetCtx(),
        ...
        {
            MVABWorkCommissionAmt amt = new MVABWorkCommissionAmt(GetCtx(), GetVAB_WorkCommission_Amt_ID(), Get_TrxName());
