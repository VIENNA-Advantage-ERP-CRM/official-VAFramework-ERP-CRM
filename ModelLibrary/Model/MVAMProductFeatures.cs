 ...
 * Class Name     : MVAMProductFeatures
...
{
    public class MVAMProductFeatures : X_VAM_ProductFeatures
    {
        #region variable
        ...
        public MVAMProductFeatures(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        /// <summary>
        ...
        /// <param name="rs">result set</param>
        /// <param name="trxName">transaction</param>
        public MVAMProductFeatures(Ctx ctx, int VAM_ProductFeatures_ID, Trx trxName)
