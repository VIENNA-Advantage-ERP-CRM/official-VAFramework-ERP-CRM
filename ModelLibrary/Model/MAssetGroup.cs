...
{
    public class MAssetGroup : X_VAA_AssetGroup
    {
        //	Categopry Cache				
        //private static CCache s_cache = new CCache("VAA_AssetGroup", 10);
        private static CCache<int, MAssetGroup> s_cache = new CCache<int, MAssetGroup>("VAA_AssetGroup", 10);
        ...
        *	@return category
        */
        public static MAssetGroup Get(Ctx ctx, int VAA_AssetGroup_ID)
        {
            int key = VAA_AssetGroup_ID;
            MAssetGroup pc = (MAssetGroup)s_cache[key];
            if (pc == null)
                pc = new MAssetGroup(ctx, VAA_AssetGroup_ID, null);
            return pc;
        }
         ...
         *	@param trxName trx
         */
        public MAssetGroup(Ctx ctx, int VAA_AssetGroup_ID, Trx trxName)
