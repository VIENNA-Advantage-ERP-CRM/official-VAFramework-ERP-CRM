...
namespace VAdvantage.Model
{
    ...
    public class MVABOrderLine : X_VAB_OrderLine
    {
        ...
        //	Product Pricing
        private MVAMProductPricing _productPrice = null;
        ...
        private MVAMProductPricing GetProductPricing(int VAM_PriceList_ID)
        {
            _productPrice = new MVAMProductPricing(GetVAF_Client_ID(), GetVAF_Org_ID(),
        ...
        public void SetVAM_Product_ID(String oldVAM_Product_ID, String newVAM_Product_ID, int windowNo)
        {
            ...
            if (IsSOTrx)
            {
                ...
                if (product.IsStocked())
                {
                    ...
                    Decimal available = (Decimal)MVAMStorage.GetQtyAvailable
        ...
        public Decimal GetProductLineCost(MVABOrderLine orderline)
        {
            ...
            MVABTaxRate tax = MVABTaxRate.Get(orderline.GetCtx(), orderline.GetVAB_TaxRate_ID());
            if (tax.Get_ColumnIndex("IsIncludeInCost") >= 0)
            {
                ...
                {
                    if (MVABTaxRate.Get(orderline.GetCtx(), tax.GetSurcharge_Tax_ID()).IsIncludeInCost())
                    {
        ...
        private bool SetAmt(int windowNo, String columnName)
        {
                ...
                && !"N".Equals(GetCtx().GetContext(windowNo, "DiscountSchema")))
            {
                ...
                if (columnName.Equals("QtyEntered"))
                    qtyOrdered = (Decimal)MVABUOMConversion.ConvertProductTo(GetCtx(), VAM_Product_ID, VAB_UOM_To_ID, qtyEntered);
                if (qtyOrdered == null)
                ...
                //
                priceEntered = (Decimal)MVABUOMConversion.ConvertProductFrom(GetCtx(), VAM_Product_ID, VAB_UOM_To_ID, pp.GetPriceStd());
            ...
            if (columnName.Equals("Discount"))
            {
                ...
                priceEntered = (Decimal)MVABUOMConversion.ConvertProductFrom(GetCtx(), VAM_Product_ID, VAB_UOM_To_ID, priceActual);
                if (priceEntered == null)
                    priceEntered = priceActual;
                SetPriceActual(priceActual);
                SetPriceEntered(priceEntered);
            ...
            if (enforce && (Double)PriceLimit != 0.0 && priceActual.CompareTo(PriceLimit) < 0)
            {
                ...
                priceEntered = (Decimal)MVABUOMConversion.ConvertProductFrom(GetCtx(), VAM_Product_ID, VAB_UOM_To_ID, PriceLimit);
                if (priceEntered == null)
                {
        ...
        private bool SetQty(int windowNo, String columnName)
        {
            ...
            else if (columnName.Equals("VAB_UOM_ID") || columnName.Equals("Orig_InOutLine_ID"))
            {
                ...
                qtyOrdered = (Decimal)MVABUOMConversion.ConvertProductFrom(GetCtx(), VAM_Product_ID, VAB_UOM_To_ID, qtyEntered);
                if (qtyOrdered == null)
                {
                    qtyOrdered = qtyEntered;
                }
            ...
            else if (columnName.Equals("QtyOrdered"))
            {
                ...
                qtyEntered = (Decimal)MVABUOMConversion.ConvertProductTo(GetCtx(), VAM_Product_ID, VAB_UOM_To_ID, qtyOrdered);
                if (qtyEntered == null)
                {
            ...
            if (VAM_Product_ID != 0 && GetCtx().IsSOTrx(windowNo) && qtyOrdered > 0 && !isReturnTrx)		//	no negative (returns)
            {
                ...
                if (product.IsStocked())
                {
                    ...
                    Decimal available = (Decimal)MVAMStorage.GetQtyAvailable(VAM_Warehouse_ID, VAM_Product_ID, VAM_PFeature_SetInstance_ID, null);
                    if (available == null)
                    {
                        available = Env.ZERO;
                    }
        ...
        protected override bool BeforeSave(bool newRecord)
        {
            ...
            if (newRecord || (Is_ValueChanged("VAM_Product_ID")) || (Is_ValueChanged("VAM_PFeature_SetInstance_ID")))
            {
                ...
                if (!Ord.IsReturnTrx())
                {
                    currentcostprice = MVAMVAMProductCost.GetproductCosts(GetVAF_Client_ID(), GetVAF_Org_ID(), GetVAM_Product_ID(), Util.GetValueOfInt(GetVAM_PFeature_SetInstance_ID()), Get_Trx(), Ord.GetVAM_Warehouse_ID());
            ...
            if (!(Util.GetValueOfInt(Ord.GetVAPOS_POSTerminal_ID()) > 0))
            {
                ...
                else	//	Set/check Product Price
                {
                    ...
                    //if (conversion)
                    //{
                    Decimal? qtyRel = MVABUOMConversion.ConvertProductTo(GetCtx(), GetVAM_Product_ID(), GetVAB_UOM_ID(), QtyReleased);
                    Decimal? qtyOrd = MVABUOMConversion.ConvertProductTo(GetCtx(), GetVAM_Product_ID(), GetVAB_UOM_ID(), QtyOrdered);
                    Decimal? qtyRes = MVABUOMConversion.ConvertProductTo(GetCtx(), GetVAM_Product_ID(), GetVAB_UOM_ID(), QtyReserved);
                    if (qtyRel != null)
                    {
                        QtyReleased = qtyRel;
                    }
            ...
            if (isReturnTrx)
            {
                ...
                else
                {
                    ...
                    MVAMReturnRule rpolicy = new MVAMReturnRule(GetCtx(), order.GetVAM_ReturnRule_ID(), Get_TrxName());
                        ...
                        if (GetQtyReserved() > 0)
                        {
                            ...
                            if (VAM_Locator_ID == 0)
                            {
                                if (GetVAM_PFeature_SetInstance_ID() != 0)	//	Get existing Location
                                    VAM_Locator_ID = MVAMStorage.GetVAM_Locator_ID(GetVAM_Warehouse_ID(),
                            ...
                            //	Update Storage
                            MVAMStorage.Add(GetCtx(), GetVAM_Warehouse_ID(), VAM_Locator_ID,
                                GetVAM_Product_ID(),
        ...
        protected override bool AfterSave(bool newRecord, bool success)
        {
            ...
            if (!IsProcessed())
            {
                ...
                {
                    MVAMProduct prd = new MVAMProduct(GetCtx(), GetVAM_Product_ID(), Get_Trx());
        ...
        protected override bool AfterDelete(bool success)
        {
            ...
            {
                /////////////////////////////////////////////////////////////
                MVASResAssignment ra = new MVASResAssignment(GetCtx(), GetVAS_Res_Assignment_ID(), Get_TrxName());
                ra.Delete(true);
            }
        ...
        /// <returns>true, if Tax calculated</returns>
        private bool CalculateChildTax(MVABOrder order, MVABOrderTax oTax, MVABTaxRate tax, Trx trxName)
        {
