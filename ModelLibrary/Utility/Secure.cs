...
{
    public class Secure : SecureInterface
    //internal class Secure : SecureInterface
    {
        /** Default Class Name implementing SecureInterface	*/
        public static String VIENNA_SECURE_DEFAULT = "VAdvantage.Utility.Secure";
        ...
        /**	Logger						*/
        private static Logger log = Logger.GetLogger(typeof(Secure).FullName);
        ...
        /// <param name="value">Value to be encrypted</param>
        /// <returns>Encrypted Value</returns>
        public byte[] Encrypt(char[] value)
        {
            // Declare the streams used
            // to encrypt to an in memory
            // array of bytes.
        ...
        /// <param name="hex">Hexed String</param>
        /// <returns>Byte Array</returns>
        private byte[] CharArrayToByteArray(char[] hex)
        {
            ...
            {
                bytes[i] = Convert.ToByte((hex[index].ToString() + hex[index + 1].ToString()), 16);
                index += 2;
            }
