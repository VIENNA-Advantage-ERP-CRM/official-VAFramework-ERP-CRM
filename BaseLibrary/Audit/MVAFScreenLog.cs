...
{
    public class MVAFScreenLog : X_VAF_ScreenLog
    {
        /// <summary>
        ...
        public MVAFScreenLog(Ctx ctx, int VAF_ScreenLog_ID, Trx trxName)
        ...
        public MVAFScreenLog(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        ...
        public MVAFScreenLog(Ctx ctx, int VAF_Session_ID,
