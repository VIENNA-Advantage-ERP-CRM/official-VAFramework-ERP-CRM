...
namespace VAdvantage.Model
{
    ...
    public class MVAFAlterLog : X_VAF_AlterLog
    {
        ...
        //	Logger					
        private static VLogger _log = VLogger.GetVLogger(typeof(MVAFAlterLog).FullName);
        /** NULL Value				*/
        ...
        int VAF_Column_ID, String type)
        {
            ...
            //    //|| VAF_TableView_ID == MVAFIssue.Table_ID
            //    || VAF_Column_ID == 6652
        ...
        public MVAFAlterLog(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        ...
        /// <param name="trxName"></param>
        public MVAFAlterLog(Ctx ctx, int VAF_AlterLog_ID, Trx trxName)
            : base(ctx, 0, trxName)
        {
        ...
        public MVAFAlterLog(Ctx ctx, int VAF_AlterLog_ID, String trxName,
        int VAF_Session_ID,
