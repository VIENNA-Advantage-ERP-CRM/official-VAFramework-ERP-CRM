...
#pragma warning disable 612, 618
    public class DB
    {
        ...
        //{
        //    return VAdvantage.SqlExec.ExecuteQuery.ExecuteReader(sql, null);
        //}
        ...
        //{
        //    return VAdvantage.SqlExec.ExecuteQuery.ExecuteDataset(sql, null);
        //}
        ...
        public static int GetSQLValue(Trx trxName, String sql)
        {
            ...
            try
            {
                ...
                if (idr.Read())
                    retValue = Util.GetValueOfInt(idr[0].ToString());
                else
                {
        ...
        public static int GetSQLValue(Trx trxName, String sql, int int_param1)
        {
            ...
            try
            {
                ...
                if (dr.Read())
                {
                    retValue = Util.GetValueOfInt(dr[0].ToString());
                }
                else
                {
