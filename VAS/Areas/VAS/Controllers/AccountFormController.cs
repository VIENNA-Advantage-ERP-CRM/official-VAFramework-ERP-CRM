...
namespace VIS.Controllers
{
    public class AccountFormController : Controller
    {
        ...
        /// <returns></returns>
        public JsonResult Save(string VAF_Client_ID, string VAF_Org_ID, string VAB_AccountBook_ID, string AD_Account_ID, string VAB_SubAcct_ID, string M_Product_ID,
            ...
            string UserElement5_ID, string UserElement6_ID, string UserElement7_ID, string UserElement8_ID, string UserElement9_ID, string Alias)
        {
            if (Session["Ctx"] != null)
            {
                ...
                var value = obj.SaveAccount(ctx, Convert.ToInt32(VAF_Client_ID), Convert.ToInt32(VAF_Org_ID), Convert.ToInt32(VAB_AccountBook_ID),
                    Convert.ToInt32(AD_Account_ID), Convert.ToInt32(VAB_SubAcct_ID), Convert.ToInt32(M_Product_ID), Convert.ToInt32(VAB_BusinessPartner_ID), Convert.ToInt32(VAF_OrgTrx_ID), 
