...
namespace VIS.Controllers
{
    public class AccountFormController : Controller
    {
        ...
        /// <returns></returns>
        public JsonResult Save(string VAF_Client_ID, string VAF_Org_ID, string VAB_AccountBook_ID, string VAF_Account_ID, string VAB_SubAcct_ID, string VAM_Product_ID,
            string VAB_BusinessPartner_ID, string VAF_OrgTrx_ID, string VAB_LocFrom_ID, string VAB_LocTo_ID, string C_SRegion_ID, string VAB_Project_ID, string VAB_Promotion_ID,
            ...
            string UserElement5_ID, string UserElement6_ID, string UserElement7_ID, string UserElement8_ID, string UserElement9_ID, string Alias)
        {
            if (Session["Ctx"] != null)
            {
                ...
                var value = obj.SaveAccount(ctx, Convert.ToInt32(VAF_Client_ID), Convert.ToInt32(VAF_Org_ID), Convert.ToInt32(VAB_AccountBook_ID),
                    Convert.ToInt32(VAF_Account_ID), Convert.ToInt32(VAB_SubAcct_ID), Convert.ToInt32(VAM_Product_ID), Convert.ToInt32(VAB_BusinessPartner_ID), Convert.ToInt32(VAF_OrgTrx_ID), 
                    Convert.ToInt32(VAB_LocFrom_ID), Convert.ToInt32(VAB_LocTo_ID), Convert.ToInt32(C_SRegion_ID), Convert.ToInt32(VAB_Project_ID), Convert.ToInt32(VAB_Promotion_ID),
