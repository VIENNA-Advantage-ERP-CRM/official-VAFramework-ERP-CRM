...
{
    public class MWorkflowProcessorLog : X_VAF_WFlowHandlerLog,ViennaProcessorLog
    {
        /// <summary>
        ...
        public MWorkflowProcessorLog(Ctx ctx, int VAF_WFlowHandlerLog_ID, Trx trxName)
