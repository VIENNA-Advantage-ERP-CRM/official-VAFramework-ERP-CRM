...
{
    public class MVAFWFlowNextCondition : X_VAF_WFlow_NextCondition
    {
        /**	Numeric evaluation		*/
        ...
        public MVAFWFlowNextCondition(Ctx ctx, int id, Trx trxName)
            : base(ctx, id, trxName)
        {
        ...
        /// <param name="trxName">transaction</param>
        public MVAFWFlowNextCondition(Ctx ctx, System.Data.DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        ...
        public bool Evaluate(MVAFWFlowTask activity)
        {
