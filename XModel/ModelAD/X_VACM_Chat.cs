...
public class X_VACM_Chat : PO
{
public X_VACM_Chat (Context ctx, int VACM_Chat_ID, Trx trxName) : base (ctx, VACM_Chat_ID, trxName)
{
/** if (VACM_Chat_ID == 0)
{
...
public X_VACM_Chat (Ctx ctx, int VACM_Chat_ID, Trx trxName) : base (ctx, VACM_Chat_ID, trxName)
{
/** if (VACM_Chat_ID == 0)
{
SetVAF_TableView_ID (0);
...
*/
public X_VACM_Chat (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_VACM_Chat (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_VACM_Chat (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
