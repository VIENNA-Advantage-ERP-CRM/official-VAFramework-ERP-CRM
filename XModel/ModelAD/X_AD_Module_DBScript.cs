...
using System;using System.Text;using VAdvantage.DataBase;using VAdvantage.Common;using VAdvantage.Classes;using VAdvantage.Process;using VAdvantage.Model;using VAdvantage.Utility;using System.Data;/** Generated Model for VAF_Module_DBScript
 *  @author Raghu (Updated) 
 *  @version Vienna Framework 1.1.1 - $Id$ */
public class X_VAF_Module_DBScript : PO{public X_VAF_Module_DBScript (Context ctx, int VAF_Module_DBScript_ID, Trx trxName) : base (ctx, VAF_Module_DBScript_ID, trxName){/** if (VAF_Module_DBScript_ID == 0){SetVAF_ModuleInfo_ID (0);SetVAF_Module_DBScript_ID (0);} */
}public X_VAF_Module_DBScript (Ctx ctx, int VAF_Module_DBScript_ID, Trx trxName) : base (ctx, VAF_Module_DBScript_ID, trxName){/** if (VAF_Module_DBScript_ID == 0){SetVAF_ModuleInfo_ID (0);SetVAF_Module_DBScript_ID (0);} */
}/** Load Constructor 
@param ctx context
@param rs result set 
@param trxName transaction
*/
public X_VAF_Module_DBScript (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName){}/** Load Constructor 
@param ctx context
@param rs result set 
@param trxName transaction
*/
public X_VAF_Module_DBScript (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName){}/** Load Constructor 
@param ctx context
@param rs result set 
@param trxName transaction
*/
public X_VAF_Module_DBScript (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName){}/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_VAF_Module_DBScript(){ Table_ID = Get_Table_ID(Table_Name); model = new KeyNamePair(Table_ID,Table_Name);}/** Serial Version No */
...
/** TableName=VAF_Module_DBScript */
public static String Table_Name="VAF_Module_DBScript";
...
@return info
*/
public override String ToString(){StringBuilder sb = new StringBuilder ("X_VAF_Module_DBScript[").Append(Get_ID()).Append("]");return sb.ToString();}/** Set ModuleInfo.
@param VAF_ModuleInfo_ID ModuleInfo */
public void SetVAF_ModuleInfo_ID (int VAF_ModuleInfo_ID){if (VAF_ModuleInfo_ID < 1) throw new ArgumentException ("VAF_ModuleInfo_ID is mandatory.");Set_ValueNoCheck ("VAF_ModuleInfo_ID", VAF_ModuleInfo_ID);}/** Get ModuleInfo.
@return ModuleInfo */
public int GetVAF_ModuleInfo_ID() {Object ii = Get_Value("VAF_ModuleInfo_ID");if (ii == null) return 0;return Convert.ToInt32(ii);}/** Set Module DBScript.
@param VAF_Module_DBScript_ID Module DBScript */
