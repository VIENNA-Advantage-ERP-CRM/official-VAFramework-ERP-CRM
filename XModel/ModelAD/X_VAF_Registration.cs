...
public class X_VAF_Registration : PO
{
public X_VAF_Registration (Context ctx, int AD_Registration_ID, Trx trxName) : base (ctx, AD_Registration_ID, trxName)
{
...
public X_VAF_Registration (Ctx ctx, int AD_Registration_ID, Trx trxName) : base (ctx, AD_Registration_ID, trxName)
{
/** if (AD_Registration_ID == 0)
{
SetAD_Registration_ID (0);
...
*/
public X_VAF_Registration (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_VAF_Registration (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_VAF_Registration (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_VAF_Registration()
{
...
{
StringBuilder sb = new StringBuilder ("X_VAF_Registration[").Append(Get_ID()).Append("]");
return sb.ToString();
}
