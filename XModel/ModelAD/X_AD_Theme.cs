...
using System;using System.Text;using VAdvantage.DataBase;using VAdvantage.Common;using VAdvantage.Classes;using VAdvantage.Process;using VAdvantage.Model;using VAdvantage.Utility;using System.Data;/** Generated Model for VAF_Theme
 *  @author Raghu (Updated) 
 *  @version Vienna Framework 1.1.1 - $Id$ */
public class X_VAF_Theme : PO{public X_VAF_Theme (Context ctx, int VAF_Theme_ID, Trx trxName) : base (ctx, VAF_Theme_ID, trxName){/** if (VAF_Theme_ID == 0){SetVAF_Theme_ID (0);SetName (null);} */
}public X_VAF_Theme (Ctx ctx, int VAF_Theme_ID, Trx trxName) : base (ctx, VAF_Theme_ID, trxName){/** if (VAF_Theme_ID == 0){SetVAF_Theme_ID (0);SetName (null);} */
}/** Load Constructor 
@param ctx context
@param rs result set 
@param trxName transaction
*/
public X_VAF_Theme (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName){}/** Load Constructor 
@param ctx context
@param rs result set 
@param trxName transaction
*/
public X_VAF_Theme (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName){}/** Load Constructor 
@param ctx context
@param rs result set 
@param trxName transaction
*/
public X_VAF_Theme (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName){}/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_VAF_Theme(){ Table_ID = Get_Table_ID(Table_Name); model = new KeyNamePair(Table_ID,Table_Name);}/** Serial Version No */
...
/** TableName=VAF_Theme */
public static String Table_Name="VAF_Theme";
...
@return info
*/
public override String ToString(){StringBuilder sb = new StringBuilder ("X_VAF_Theme[").Append(Get_ID()).Append("]");return sb.ToString();}/** Set VAF_Theme_ID.
@param VAF_Theme_ID VAF_Theme_ID */
public void SetVAF_Theme_ID (int VAF_Theme_ID){if (VAF_Theme_ID < 1) throw new ArgumentException ("VAF_Theme_ID is mandatory.");Set_ValueNoCheck ("VAF_Theme_ID", VAF_Theme_ID);}/** Get VAF_Theme_ID.
@return VAF_Theme_ID */
public int GetVAF_Theme_ID() {Object ii = Get_Value("VAF_Theme_ID");if (ii == null) return 0;return Convert.ToInt32(ii);}/** Set Export.
