...
@return Identifies the production resource detail lines in a work order transaction */
        public int GetVAM_WorkOrderResourceTxnLine_ID() { Object ii = Get_Value("VAM_WorkOrderResourceTxnLine_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }/** Set Work Order Transaction Line.
...
@return Work Order Transaction Line */
        public int GetVAM_WorkOrderTransactionLine_ID() { Object ii = Get_Value("VAM_WorkOrderTransactionLine_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }/** Set Price.
@param Price Price */
