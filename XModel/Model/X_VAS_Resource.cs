 ...
 *  @version Vienna Framework 1.1.1 - $Id$ */
    public class X_VAS_Resource : PO
    {
        public X_VAS_Resource(Context ctx, int VAS_Resource_ID, Trx trxName)
        ...
        public X_VAS_Resource(Ctx ctx, int VAS_Resource_ID, Trx trxName)
            : base(ctx, VAS_Resource_ID, trxName)
        {
            /** if (VAS_Resource_ID == 0)
            {
        ...
        */
        public X_VAS_Resource(Context ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        /** Load Constructor 
        ...
        @param trxName transaction
        */
        public X_VAS_Resource(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        /** Load Constructor 
        ...
        @param trxName transaction
        */
        public X_VAS_Resource(Ctx ctx, IDataReader dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }
        /** Static Constructor 
        ...
        */
        ...
        {
            StringBuilder sb = new StringBuilder("X_VAS_Resource[").Append(Get_ID()).Append("]");
            return sb.ToString();
        }
        /** Set User/Contact.
