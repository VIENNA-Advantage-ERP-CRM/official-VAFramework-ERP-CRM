namespace VAdvantage.Model
{
    ...
    public class X_VAI_Order : PO
    {
        public X_VAI_Order(Context ctx, int I_Order_ID, Trx trxName)
        ...
        public X_VAI_Order(Ctx ctx, int I_Order_ID, Trx trxName)
            : base(ctx, I_Order_ID, trxName)
        {
            /** if (I_Order_ID == 0)
            {
        ...
        */
        public X_VAI_Order(Context ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        /** Load Constructor 
        ...
        @param trxName transaction
        */
        public X_VAI_Order(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        /** Load Constructor 
        ...
        @param trxName transaction
        */
        public X_VAI_Order(Ctx ctx, IDataReader dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }
        /** Static Constructor 
