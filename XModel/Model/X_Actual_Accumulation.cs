...
using System;using System.Text;using VAdvantage.DataBase;using VAdvantage.Common;using VAdvantage.Classes;using VAdvantage.Process;using VAdvantage.Model;using VAdvantage.Utility;using System.Data;/** Generated Model for Actual_Accumulation
 *  @author Raghu (Updated) 
 *  @version Vienna Framework 1.1.1 - $Id$ */
public class X_Actual_Accumulation : PO{public X_Actual_Accumulation (Context ctx, int Actual_Accumulation_ID, Trx trxName) : base (ctx, Actual_Accumulation_ID, trxName){/** if (Actual_Accumulation_ID == 0){SetACTUAL_ACCUMULATION_ID (0);} */
}public X_Actual_Accumulation (Ctx ctx, int Actual_Accumulation_ID, Trx trxName) : base (ctx, Actual_Accumulation_ID, trxName){/** if (Actual_Accumulation_ID == 0){SetACTUAL_ACCUMULATION_ID (0);} */
}/** Load Constructor 
@param ctx context
@param rs result set 
@param trxName transaction
*/
public X_Actual_Accumulation (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName){}/** Load Constructor 
@param ctx context
@param rs result set 
@param trxName transaction
*/
public X_Actual_Accumulation (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName){}/** Load Constructor 
@param ctx context
@param rs result set 
@param trxName transaction
*/
public X_Actual_Accumulation (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName){}/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_Actual_Accumulation(){ Table_ID = Get_Table_ID(Table_Name); model = new KeyNamePair(Table_ID,Table_Name);}/** Serial Version No */
...
/** TableName=Actual_Accumulation */
public static String Table_Name="Actual_Accumulation";
...
@return info
*/
public override String ToString(){StringBuilder sb = new StringBuilder ("X_Actual_Accumulation[").Append(Get_ID()).Append("]");return sb.ToString();}
...
public void SetACTUAL_ACCUMULATION_ID (int ACTUAL_ACCUMULATION_ID){if (ACTUAL_ACCUMULATION_ID < 1) throw new ArgumentException ("ACTUAL_ACCUMULATION_ID is mandatory.");Set_ValueNoCheck ("ACTUAL_ACCUMULATION_ID", ACTUAL_ACCUMULATION_ID);}/** Get ACTUAL_ACCUMULATION_ID.
@return ACTUAL_ACCUMULATION_ID */
public int GetACTUAL_ACCUMULATION_ID() {Object ii = Get_Value("ACTUAL_ACCUMULATION_ID");if (ii == null) return 0;return Convert.ToInt32(ii);}/** Set ISACTIVITY.
