...
using System.Data;
/** Generated Model for VAB_GenFeatureSet
 *  @author Jagmohan Bhatt (generated) 
 *  @version Vienna Framework 1.1.1 - $Id$ */
public class X_VAB_GenFeatureSet : PO
{
public X_VAB_GenFeatureSet (Context ctx, int VAB_GenFeatureSet_ID, Trx trxName) : base (ctx, VAB_GenFeatureSet_ID, trxName)
{
/** if (VAB_GenFeatureSet_ID == 0)
{
...
public X_VAB_GenFeatureSet (Ctx ctx, int VAB_GenFeatureSet_ID, Trx trxName) : base (ctx, VAB_GenFeatureSet_ID, trxName)
{
/** if (VAB_GenFeatureSet_ID == 0)
{
SetVAB_GenFeatureSet_ID (0);
...
*/
public X_VAB_GenFeatureSet (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_VAB_GenFeatureSet (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_VAB_GenFeatureSet (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_VAB_GenFeatureSet()
{
...
/** TableName=VAB_GenFeatureSet */
public static String Table_Name="VAB_GenFeatureSet";
...
{
StringBuilder sb = new StringBuilder ("X_VAB_GenFeatureSet[").Append(Get_ID()).Append("]");
return sb.ToString();
}
