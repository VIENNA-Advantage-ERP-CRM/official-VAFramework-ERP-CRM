...
public class X_VACM_ChatType : PO
{
public X_VACM_ChatType (Context ctx, int VACM_ChatType_ID, Trx trxName) : base (ctx, VACM_ChatType_ID, trxName)
{
...
public X_VACM_ChatType (Ctx ctx, int VACM_ChatType_ID, Trx trxName) : base (ctx, VACM_ChatType_ID, trxName)
{
/** if (VACM_ChatType_ID == 0)
{
SetVAF_TableView_ID (0);
...
*/
public X_VACM_ChatType (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_VACM_ChatType (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_VACM_ChatType (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_VACM_ChatType()
{
