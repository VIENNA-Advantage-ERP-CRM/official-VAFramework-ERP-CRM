namespace VAdvantage.Model
{
    ...
    public class X_VAA_Asset : PO
    {
        public X_VAA_Asset(Context ctx, int VAA_Asset_ID, Trx trxName)
        ...
        public X_VAA_Asset(Ctx ctx, int VAA_Asset_ID, Trx trxName)
            : base(ctx, VAA_Asset_ID, trxName)
        {
            /** if (VAA_Asset_ID == 0)
            {
        ...
        */
        public X_VAA_Asset(Context ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        /** Load Constructor 
        ...
        @param trxName transaction
        */
        public X_VAA_Asset(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        /** Load Constructor 
        ...
        @param trxName transaction
        */
        public X_VAA_Asset(Ctx ctx, IDataReader dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }
        /** Static Constructor 
