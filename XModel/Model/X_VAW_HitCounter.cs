...
public class X_VAW_HitCounter : PO
{
public X_VAW_HitCounter (Context ctx, int W_Counter_ID, Trx trxName) : base (ctx, W_Counter_ID, trxName)
{
/** if (W_Counter_ID == 0)
{
SetPageURL (null);
...
public X_VAW_HitCounter (Ctx ctx, int W_Counter_ID, Trx trxName) : base (ctx, W_Counter_ID, trxName)
{
/** if (W_Counter_ID == 0)
{
SetPageURL (null);
...
*/
public X_VAW_HitCounter (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_VAW_HitCounter (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_VAW_HitCounter (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_VAW_HitCounter()
{
...
{
StringBuilder sb = new StringBuilder ("X_VAW_HitCounter[").Append(Get_ID()).Append("]");
return sb.ToString();
}
/** Set User/Contact.
