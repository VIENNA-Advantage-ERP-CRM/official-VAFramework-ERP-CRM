...
using System.Data;
/** Generated Model for VAM_Product_TL
 *  @author Jagmohan Bhatt (generated) 
 *  @version Vienna Framework 1.1.1 - $Id$ */
public class X_VAM_Product_TL : PO
{
public X_VAM_Product_TL (Context ctx, int VAM_Product_TL_ID, Trx trxName) : base (ctx, VAM_Product_TL_ID, trxName)
{
/** if (VAM_Product_TL_ID == 0)
{
...
public X_VAM_Product_TL (Ctx ctx, int VAM_Product_TL_ID, Trx trxName) : base (ctx, VAM_Product_TL_ID, trxName)
{
/** if (VAM_Product_TL_ID == 0)
{
SetVAF_Language (null);
...
*/
public X_VAM_Product_TL (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_VAM_Product_TL (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_VAM_Product_TL (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_VAM_Product_TL()
{
...
/** VAF_TableView_ID=312 */
public static int Table_ID;
 // =312;

/** TableName=VAM_Product_TL */
public static String Table_Name="VAM_Product_TL";
...
{
StringBuilder sb = new StringBuilder ("X_VAM_Product_TL[").Append(Get_ID()).Append("]");
return sb.ToString();
}
