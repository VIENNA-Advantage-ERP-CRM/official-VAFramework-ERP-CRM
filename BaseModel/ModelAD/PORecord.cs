...
namespace VAdvantage.Model
{
    ...
    {
        void Register(IPORecord record);

    }
    /// <summary>
    /// To delete various attachments/chats/etc. of a record
    /// </summary>
   public class PORecordMgmt
    {


        private static List<IPORecord> _types = new List<IPORecord>();


        public void Register(IPORecord record)
        {
            if (!_types.Contains(record))
                _types.Add(record);
        }
