...
{
    public class MVAFNotice : X_VAF_Notice
    {
        /// <summary>
        ...
        public MVAFNotice(Ctx ctx, int VAF_Notice_ID, Trx trxName)
        ...
        /// <param name="trxName">transaction</param>
        public MVAFNotice(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
            // changes done by Bharat on 22 May 2018 to set Organization to * on Notification as discussed with Mukesh Sir.
            SetVAF_Org_ID(0);
        ...
        /// <param name="trxName">transaction</param>
        public MVAFNotice(Ctx ctx, int VAF_Msg_Lable_ID, int VAF_UserContact_ID, Trx trxName)
            : this(ctx, 0, trxName)
        {
        ...
        /// <param name="VAF_UserContact_ID">targeted user</param>
        /// <param name="trxName">transaction</param>
        public MVAFNotice(Ctx ctx, string VAF_Msg_LableValue, int VAF_UserContact_ID, Trx trxName)
            : this(ctx, MVAFMsgLable.GetVAF_Msg_Lable_ID(ctx, VAF_Msg_LableValue), VAF_UserContact_ID, trxName)
        {
            // changes done by Bharat on 22 May 2018 to set Organization to * on Notification as discussed with Mukesh Sir.
            SetVAF_Org_ID(0);
        }
        ...
        /// <param name="trxName">transaction</param>
        public MVAFNotice(Ctx ctx, int VAF_Msg_Lable_ID, int VAF_UserContact_ID,
        ...
        public MVAFNotice(Ctx ctx, int VAF_Msg_Lable_ID, int VAF_UserContact_ID, int VAF_Client_ID, int VAF_Org_ID, int VAF_TableView_ID, int Record_ID, String Reference, Trx trxName)
            : this(ctx,VAF_Msg_Lable_ID, VAF_UserContact_ID, trxName)
        {
        ...
        /// <param name="trxName">transaction</param>
        public MVAFNotice(Ctx ctx, string VAF_Msg_LableValue, int VAF_UserContact_ID,
        ...
        public new void SetVAF_Msg_Lable_ID(int VAF_Msg_Lable_ID)
        {
            ...
            {
                base.SetVAF_Msg_Lable_ID(MVAFMsgLable.GetVAF_Msg_Lable_ID(GetCtx(), "NoMessageFound"));
            }
            else
            {
                base.SetVAF_Msg_Lable_ID(VAF_Msg_Lable_ID);
        ...
        public string GetMessage()
        {
            ...
            MVAFMsgLable msg = MVAFMsgLable.Get(GetCtx(), VAF_Msg_Lable_ID);
