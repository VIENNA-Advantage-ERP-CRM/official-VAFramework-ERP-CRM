...
{
    public class MVAFGroupForm : X_VAF_Group_Form
    {
        /// <summary>
        ...
        public MVAFGroupForm(Ctx ctx, int VAF_GroupForm_ID, Trx trxName)
        ...
        /// <param name="trxName">transaction</param>
        public MVAFGroupForm(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {

        }
        public MVAFGroupForm(Ctx ctx, IDataReader idr, Trx trxName)
        ...
        private void InsertNewRecordInRole()
        {
            ...
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    MVAFPageRights access = new MVAFPageRights(GetCtx(), 0, null);
