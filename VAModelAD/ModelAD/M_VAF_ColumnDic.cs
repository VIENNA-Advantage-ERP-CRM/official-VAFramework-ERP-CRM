...
{
    public class M_VAFColumnDic : X_VAF_ColumnDic
    {
        //	Logger	
        private static VLogger _log = VLogger.GetVLogger(typeof(M_VAFColumnDic).FullName);
        /// <summary>
        ...
        /// <param name="columnName">columnName case insensitive column name</param>
        /// <returns>case sensitive column name</returns>
        public static M_VAFColumnDic Get(Ctx ctx, String columnName)
        {
            if (columnName == null || columnName.Length == 0)
                return null;
            M_VAFColumnDic retValue = null;
            ...
            try
            {
                ...
                {
                    DataRow rs = ds.Tables[0].Rows[i];
                    retValue = new M_VAFColumnDic(ctx, rs, null);
        ...
        public static M_VAFColumnDic Get(Ctx ctx, String columnName, Trx trxName)
        {
            if (columnName == null || columnName.Length == 0)
                return null;
            M_VAFColumnDic retValue = null;
            ...
            try
            {
                ...
                {
                    DataRow rs = ds.Tables[0].Rows[i];
                    retValue = new M_VAFColumnDic(ctx, rs, trxName);
                    _log.Warning("Not unique: " + columnName + " -> " + retValue + " - " + rs["ColumnName"].ToString());
                }
                ds = null;
            }
        ...
        /// <returns>case sensitive column name</returns>
        public static M_VAFColumnDic GetOfColumn(Ctx ctx, int VAF_Column_ID)
        {
            if (VAF_Column_ID == 0)
                return null;
            M_VAFColumnDic retValue = null;
        ...
        public M_VAFColumnDic(Ctx ctx, int VAF_ColumnDic_ID, Trx trxName)
        ...
        /// <param name="trxName">transaction</param>
        public M_VAFColumnDic(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
