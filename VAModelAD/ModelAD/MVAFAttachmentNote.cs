...
{
    public class MVAFAttachmentNote : X_VAF_AttachmentNote
    {
        /// <summary>
        ...
        public MVAFAttachmentNote(Ctx ctx, int VAF_AttachmentNote_ID, Trx trxName)
        ...
        /// <param name="trxName">transaction</param>
        public MVAFAttachmentNote(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        ...
        public MVAFAttachmentNote(MVAFAttachment attach, string Title, string TextMsg)
