...
{
    public class MVAFAllotCriteria : X_VAF_AllotCriteria
    {
        /**
         ...
         *	@param trxName trx
         */
        public MVAFAllotCriteria(Ctx ctx, int VAF_AllotCriteria_ID, Trx trxName)
         ...
         *	@param trxName trx
         */
        public MVAFAllotCriteria(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        ...
        {
            MVAFColumn column = GetSourceColumn();
