...
{
    public class MVAFUserMailLog : X_VAF_UserMailLog
    {
        /// <summary>
        ...
        public MVAFUserMailLog(Ctx ctx, int VAF_UserMailLog_ID, Trx trxName)
        ...
        public MVAFUserMailLog(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        ...
        /// <param name="VAF_UserContact_ID">recipient user</param>
        /// <param name="mail">email</param>
        public MVAFUserMailLog(PO po, int VAF_UserContact_ID, EMail mail)
