...
{
 public class MVAFScreenRights : X_VAF_Screen_Rights
    {
        /// <summary>
        ...
        public MVAFScreenRights(Ctx ctx, int ignored, Trx trxName)
            : base(ctx, 0, trxName)
        {
            if (ignored != 0)
        ...
        public MVAFScreenRights(MVAFScreen parent, int VAF_Role_ID)
        ...
        /// <param name="trxName">transaction</param>
        public MVAFScreenRights(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
