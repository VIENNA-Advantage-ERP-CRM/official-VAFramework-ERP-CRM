...
{
    public class MVAFDBQueryLog : X_VAF_DBQueryLog
    {
        /// <summary>
        ...
        public MVAFDBQueryLog(Ctx ctx, int VAF_DBQueryLog_ID, Trx trxName)
        ...
        /// <param name="trxName">trx</param>
        public MVAFDBQueryLog(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        ...
        public MVAFDBQueryLog(Ctx ctx, int VAF_Session_ID,
