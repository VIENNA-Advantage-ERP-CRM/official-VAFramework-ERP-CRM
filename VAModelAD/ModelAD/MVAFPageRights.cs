...
{
    public class MVAFPageRights : X_VAF_Page_Rights
    {
        /// <summary>
        ...
        public MVAFPageRights(Ctx ctx, int ignored, Trx trxName)
            : base(ctx, 0, trxName)
        {
            if (ignored != 0)
            {
        ...
        /// <param name="trxName">transaction</param>
        public MVAFPageRights(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }
        ...
        public MVAFPageRights(MVAFPage parent, int VAF_Role_ID)
