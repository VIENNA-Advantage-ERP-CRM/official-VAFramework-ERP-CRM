...
namespace VAdvantage.Model
{
    ...
    /// </summary>
    public class MVAFUserSearchLine : X_VAF_UserSearchLine
    {
        /// <summary>
        ...
        public MVAFUserSearchLine(Context ctx, int VAF_UserSearchLine_ID, Trx trxName)
        ...
        public MVAFUserSearchLine(MVAFUserSearch parent, int seqNo, string keyName, string keyValue, string optr,
        ...
        public MVAFUserSearchLine(Context ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }
