...
{
    public class MVAFRecordRights : X_VAF_Record_Rights
    {
       ...
       // private static long serialVersionUID = -5115765616266528435L;
        ...
        public MVAFRecordRights(Ctx ctx, int ignored, Trx trxName)
            : base(ctx, 0, trxName)
        {
            if (ignored != 0)
            {
        ...
        /// <param name="dr"></param>
        /// <param name="trxName"></param>
        public MVAFRecordRights(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        ...
        /// <param name="dr"></param>
        /// <param name="trxName"></param>
        public MVAFRecordRights(Ctx ctx, IDataReader dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        ...
        /// <param name="trxName"></param>
        public MVAFRecordRights(Ctx ctx, int VAF_Role_ID, int VAF_TableView_ID, int Record_ID, Trx trxName)
            : base(ctx, 0, trxName)
        {
