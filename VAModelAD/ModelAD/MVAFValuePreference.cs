...
namespace VAdvantage.Model
{
    ...
    /// </summary>
    public class MVAFValuePreference : X_VAF_ValuePreference
    {
        /// <summary>
        ...
        public MVAFValuePreference(Context ctx, int VAF_ValuePreference_ID, Trx trxName)
        ...
        /// <param name="trxName">transaction</param>
        public MVAFValuePreference(Context ctx, System.Data.DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }
        ...
        /// <param name="trxName">transaction</param>
        public MVAFValuePreference(Context ctx, String attribute, String value, Trx trxName)
            : this(ctx, 0, trxName)
        {
        ...
        /// <param name="VAF_ValuePreference_ID">id</param>
        /// <param name="trxName">transaction</param>
        public MVAFValuePreference(Ctx ctx, int VAF_ValuePreference_ID, Trx trxName)
            : base(ctx, VAF_ValuePreference_ID, trxName)
        {
            if (VAF_ValuePreference_ID == 0)
            {
        ...
        /// <param name="dr">data row</param>
        /// <param name="trxName">transaction</param>
        public MVAFValuePreference(Ctx ctx, System.Data.DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }
        ...
        /// <param name="value">value</param>
        /// <param name="trxName">transaction</param>
        public MVAFValuePreference(Ctx ctx, String attribute, String value, Trx trxName)
            : this(ctx, 0, trxName)
        {
            SetAttribute(attribute);
            SetValue(value);
