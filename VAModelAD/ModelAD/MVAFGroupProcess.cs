...
{
    public class MVAFGroupProcess : X_VAF_Group_Process
    {
        /// <summary>
        ...
        public MVAFGroupProcess(Ctx ctx, int VAF_GroupProcess_ID, Trx trxName)
        ...
        /// <param name="trxName">transaction</param>
        public MVAFGroupProcess(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {

        }
        public MVAFGroupProcess(Ctx ctx, IDataReader idr, Trx trxName)
