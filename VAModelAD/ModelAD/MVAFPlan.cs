...
namespace VAdvantage.Model
{
    ...
    /// Schedule  Model
    /// </summary>
    public class MVAFPlan : X_VAF_Plan
    {
        /// <summary>
        ...
        public static MVAFPlan Get(Ctx ctx, int VAF_Plan_ID)
        {
            int key = VAF_Plan_ID;
            MVAFPlan retValue = null;

            if(s_cache.ContainsKey(key))
                retValue = (MVAFPlan)s_cache[key];

            if (retValue != null)
                return retValue;
            retValue = new MVAFPlan(ctx, VAF_Plan_ID, null);
        ...
        /**	Cache						*/
        private static CCache<int, MVAFPlan> s_cache = new CCache<int, MVAFPlan>("VAF_Plan", 20);
       ...
       // int s = 0;
        ...
        public MVAFPlan(Ctx ctx, int VAF_Plan_ID, Trx trxName)
        ...
        /// <param name="trxName">optional transaction</param>
        public MVAFPlan(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        ...
        public static void TestMain()
        {
            ...
            /**	Test Case - Minutes 	**/
            s = new MVAFPlan(Env.GetContext(), 1000201, null);
