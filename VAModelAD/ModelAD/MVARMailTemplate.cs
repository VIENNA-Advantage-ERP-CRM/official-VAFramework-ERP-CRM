...
namespace VAdvantage.Model
{
    ...
    ///	Cannot be cached as it holds PO/BPartner/User to parse
    /// </summary>
    public class MVARMailTemplate : X_VAR_MailTemplate
    {
        /**	Parse User			*/
        ...
        /** Translation Cache	*/
        private static CCache<String, MVARMailTemplateTrl> cacheTrl = new CCache<String, MVARMailTemplateTrl>("", 20);
        ...
        public MVARMailTemplate(Ctx ctx, int VAR_MailTemplate_ID, Trx trxName)
        ...
        /// <param name="trxName">transaction</param>
        public MVARMailTemplate(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        ...
        /// <returns>trl</returns>
        private MVARMailTemplateTrl GetTranslation(String VAF_Language)
        {
            MVARMailTemplateTrl trl = null;
        ...
        private void Translate()
        {
            ...
            if (!string.IsNullOrEmpty(language) && language.Length > 0)
            {
                ...
                MVARMailTemplateTrl trl = cacheTrl[key];
                if (trl == null)
                {
