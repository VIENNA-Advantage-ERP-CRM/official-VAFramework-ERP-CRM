...
{
    public class MVAFModuleWindow : X_VAF_ModuleWindow
    {
        public MVAFModuleWindow(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }

        public MVAFModuleWindow(Ctx ctx, int dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }
