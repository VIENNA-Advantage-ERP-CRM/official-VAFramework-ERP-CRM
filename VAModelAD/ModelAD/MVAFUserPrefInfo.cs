...
namespace VAdvantage.Model
{
    ...
    /// </summary>
    public class MVAFUserPrefInfo : X_VAF_UserPref_Info
    {
        //	Logger						
        private static VLogger _log = VLogger.GetVLogger(typeof(MVAFUserPrefInfo).FullName);
        ...
        public MVAFUserPrefInfo(Ctx ctx, int VAF_UserPref_Info_ID, Trx trxName)
        ...
        /// <param name="trxName">transaction</param>
        public MVAFUserPrefInfo(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        ...
        public static MVAFUserPrefInfo GetOfUser(X_VAF_UserContact user, bool createNew)
        {
            MVAFUserPrefInfo retValue = null;
            ...
            try
            {
                ...
                {
                    retValue = new MVAFUserPrefInfo(user.GetCtx(), rs, null);
                }
                ds.Dispose();
            }
            catch (Exception e)
            ...
            {
                retValue = new MVAFUserPrefInfo(user.GetCtx(), 0, null);
        ...
        public static MVAFUserPrefInfo GetOfUser(PO user, bool createNew)
        {
            MVAFUserPrefInfo retValue = null;
