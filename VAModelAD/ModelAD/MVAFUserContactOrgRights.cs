...
{
    public class MVAFUserContactOrgRights : X_VAF_UserContact_OrgRights
    {
        /// <summary>
        ...
        public static MVAFUserContactOrgRights[] GetOfUser(Ctx ctx, int VAF_UserContact_ID)
        {
        ...
        /// <returns> array of User Org Access</returns>
        private static MVAFUserContactOrgRights[] Get(Ctx ctx, String sql, int id)
        {
            //ArrayList<MUserOrgAccess> list = new ArrayList<MUserOrgAccess>();
            List<MVAFUserContactOrgRights> list = new List<MVAFUserContactOrgRights>();
            ...
            try
            {
                ...
                {
                    list.Add(new MVAFUserContactOrgRights(ctx, dr, null));
                }
                dt = null;
            }
            catch (Exception e)
            ...
            MVAFUserContactOrgRights[] retValue = new MVAFUserContactOrgRights[list.Count];
        ...
        //	Static Logger
        private static VLogger _log = VLogger.GetVLogger(typeof(MVAFUserContactOrgRights).FullName);
        /// <summary>
        ///Load Constructor 
        /// </summary>
        ...
        public MVAFUserContactOrgRights(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        ...
        /// <param name="trxName">transaction</param>
        public MVAFUserContactOrgRights(Ctx ctx, int ignored, Trx trxName)
            : base(ctx, 0, trxName)
        {
            //super(ctx, 0, trxName);
            if (ignored != 0)
        ...
        public MVAFUserContactOrgRights(PO org, int VAF_UserContact_ID)
