...
{
    public class MVAFTreeInfoChildProd : X_VAF_TreeInfoChildProd
    {
        /**	Static Logger	*/
	private static VLogger	_log	= VLogger.GetVLogger (typeof(MVAFTreeInfoChildProd).FullName);
	...
	public static MVAFTreeInfoChildProd Get(MVAFTreeInfo tree, int Node_ID)
	{
		MVAFTreeInfoChildProd retValue = null;
		...
		try
		{
            ...
            {
				retValue = new MVAFTreeInfoChildProd (tree.GetCtx(), dr, tree.Get_TrxName());
            }
		}
		catch (Exception e)
		{
	...
	public MVAFTreeInfoChildProd(Ctx ctx,DataRow dr, Trx trxName):base(ctx, dr, trxName)
	{
	...
	/// <param name="tree">tree</param>
	/// <param name="Node_ID">node</param>
	public MVAFTreeInfoChildProd (MVAFTreeInfo tree, int Node_ID):base(tree.GetCtx(), 0, tree.Get_TrxName())
	{
    ...
    /// <param name="tree">tree</param>
    /// <param name="Node_ID">node</param>
    public MVAFTreeInfoChildProd(MVAFTreeInfo tree, int Node_ID, int setSeqManually)
