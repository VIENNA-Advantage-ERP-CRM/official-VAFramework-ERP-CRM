...
namespace VAdvantage.Model
{
    ...
    /// </summary>
    public class MVAFUserSearch : X_VAF_UserSearch
    {
        //	The Lines
        //private MUserQueryLine[] _lines = null;
        
        //	Logger	
        private static VLogger _log = VLogger.GetVLogger(typeof(MVAFUserSearch).FullName);
        ...
        public MVAFUserSearch(Context ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }

        public MVAFUserSearch(Ctx ctx, DataRow dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }
        ...
        public MVAFUserSearch(Context ctx, int VAF_UserSearch_ID, Trx trxName)
            : base(ctx, VAF_UserSearch_ID, trxName)
        {
        }

        public MVAFUserSearch(Ctx ctx, int VAF_UserSearch_ID, Trx trxName)
            : base(ctx, VAF_UserSearch_ID, trxName)
        {
        }
