...
{
    public class MVAFTask : X_VAF_Task
    {
        /// <summary>
        ...
        public MVAFTask(Ctx ctx, int VAF_Task_ID, Trx trxName)
       ...
       /// <param name="trxName">transaction</param>
        public MVAFTask(Ctx ctx, DataRow dr, Trx trxName):base(ctx,dr, trxName)
        {
        ...
        {
            StringBuilder sb = new StringBuilder("MVAFTask[");
            sb.Append(Get_ID())
