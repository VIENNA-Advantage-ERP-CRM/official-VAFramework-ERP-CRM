...
{
    public class MVAFPrintRptFont : X_VAF_Print_Rpt_Font
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public MVAFPrintRptFont(Context ctx, int VAF_Print_Rpt_Font_ID, Trx trxName)
        ...
        /// <param name="trxName">transaction</param>
        public MVAFPrintRptFont(Context ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }	//	MPrintFont
        ...
        public static MVAFPrintRptFont Create(Font font)
        {
            MVAFPrintRptFont pf = new MVAFPrintRptFont(VAdvantage.Utility.Env.GetContext(), 0, null);
        ...
        /** Cached Fonts						*/
        static private CCache<int, MVAFPrintRptFont> _fonts = new CCache<int, MVAFPrintRptFont>("VAF_Print_Rpt_Font", 20);

        static public MVAFPrintRptFont Get(int VAF_Print_Rpt_Font_ID)
        {
            int key = VAF_Print_Rpt_Font_ID;
            MVAFPrintRptFont pf = (MVAFPrintRptFont)_fonts[key];
            if (pf == null)
            {
                pf = new MVAFPrintRptFont(VAdvantage.Utility.Env.GetContext(), VAF_Print_Rpt_Font_ID, null);
                _fonts.Add(key, pf);
            }
            return pf;
        }	//	get
