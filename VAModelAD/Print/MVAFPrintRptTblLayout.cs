...
{
    public class MVAFPrintRptTblLayout : X_VAF_Print_Rpt_TblLayout
    {
        /// <summary>
        ...
        public MVAFPrintRptTblLayout(Ctx ctx, int VAF_Print_Rpt_TblLayout_ID, Trx trxName)
        ...
        /// <param name="trxName">transaction</param>
        public MVAFPrintRptTblLayout(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }	//	MPrintTableFormat
        ...
        public Font GetHeader_Font()
        {
            ...
            if (i != 0)
                header_Font = MVAFPrintRptFont.Get(i).GetFont();
            if (header_Font == null)
        ...
        public Color GetHeaderBG_Color()
        {
            ...
            if (i != 0)
                headerBG_Color = MVAFPrintRptColour.Get(GetCtx(), i).GetColor();
            if (headerBG_Color == null)
        ...
        public Color GetHeaderLine_Color()
        {
            ...
            if (i != 0)
                hdrLine_Color = MVAFPrintRptColour.Get(GetCtx(), i).GetColor();
            if (hdrLine_Color == null)
                hdrLine_Color = MVAFPrintRptColour.blackBlue;
            return (Color)hdrLine_Color;
        }	//	getHeaderLine_Color
        ...
        public Color GetHeaderFG_Color()
        {
            ...
            if (i != 0)
                headerFG_Color = MVAFPrintRptColour.Get(GetCtx(), i).GetColor();
            if (headerFG_Color == null)
                headerFG_Color = MVAFPrintRptColour.blackBlue;
            return (Color)headerFG_Color;
        }	//	getHeaderFG_Color
        ...
        public Font GetFunct_Font()
        {
            ...
            if (i != 0)
                funct_Font = MVAFPrintRptFont.Get(i).GetFont();
            if (funct_Font == null)
        ...
        public Color GetFunctBG_Color()
        {
            ...
            if (i != 0)
                functBG_Color = MVAFPrintRptColour.Get(GetCtx(), i).GetColor();
            if (functBG_Color == null)
        ...
        public Color GetFunctFG_Color()
        {
            ...
            if (i != 0)
                functFG_Color = MVAFPrintRptColour.Get(GetCtx(), i).GetColor();
            if (functFG_Color == null)
                functFG_Color = MVAFPrintRptColour.darkGreen;
            return (Color)functFG_Color;
        }	//	getFunctFG_Color
        ...
        public Color GetPageHeaderFG_Color()
        {
            if (pageHeaderFG_Color == null)
                pageHeaderFG_Color = MVAFPrintRptColour.blackBlue;
        ...
        public Color GetPageFooterFG_Color()
        {
            if (pageFooterFG_Color == null)
                pageFooterFG_Color = MVAFPrintRptColour.blackBlue;
        ...
        private static CCache<int, MVAFPrintRptTblLayout> _cache = new CCache<int, MVAFPrintRptTblLayout>("VAF_Print_Rpt_TblLayout", 3);

        static public MVAFPrintRptTblLayout Get(Ctx ctx, int VAF_Print_Rpt_TblLayout_ID, Font standard_font)
        {
            int ii = VAF_Print_Rpt_TblLayout_ID;
            //MPrintTableFormat tf = (MPrintTableFormat)_cache[ii];
            MVAFPrintRptTblLayout tf = null;
            if (tf == null)
            {
                if (VAF_Print_Rpt_TblLayout_ID == 0)
                    tf = GetDefault(ctx);
                else
                    tf = new MVAFPrintRptTblLayout(ctx, VAF_Print_Rpt_TblLayout_ID, null);
                _cache.Add(ii, tf);
            }
        ...
        static public MVAFPrintRptTblLayout Get(Ctx ctx, int VAF_Print_Rpt_TblLayout_ID, int VAF_Print_Rpt_Font_ID)
        {
            return Get(ctx, VAF_Print_Rpt_TblLayout_ID, MVAFPrintRptFont.Get(VAF_Print_Rpt_Font_ID).GetFont());
        }	//	get
        ...
        static public MVAFPrintRptTblLayout GetDefault(Ctx ctx)
        {
            ...
            try
            {
                ...
                {
                    tf = new MVAFPrintRptTblLayout(ctx, dr, null);
        ...
        public Color GetVLine_Color()
        {
            ...
            if (i != 0)
                lineV_Color = MVAFPrintRptColour.Get(Env.GetCtx(), i).GetColor();
            if (lineV_Color == null)
        ...
        public Color GetHLine_Color()
        {
            ...
            int i = GetLine_PrintColor_ID();
            if (i != 0)
                lineH_Color = MVAFPrintRptColour.Get(Env.GetCtx(), i).GetColor();
            if (lineH_Color == null)
