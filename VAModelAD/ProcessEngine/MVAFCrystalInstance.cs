...
{
    public class MVAFCrystalInstance : X_VAF_CrystalInstance
    {
        /// <summary>
        ...
        public MVAFCrystalInstance(Ctx ctx, int AD_CrytalInstance_ID, string ignored)
        ...
        /// <param name="ignored">no transaction support</param>
        public MVAFCrystalInstance(Ctx ctx, DataRow dr, String ignored)
            : base(ctx, dr, null)
        {
        }
        ...
        public MVAFCrystalInstance(Ctx ctx, int VAF_Page_ID, int Record_ID)
            : this(ctx, 0, null)
        {
