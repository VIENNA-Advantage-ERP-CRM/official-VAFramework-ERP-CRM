...
{
    public class MVAFCrystalInstancePara : X_VAF_CrystalInstance_Para
    {
        /// <summary>
        ...
        public MVAFCrystalInstancePara(Ctx ctx, int ignored, Trx txtName)
            : base(ctx, 0, txtName)
        {
            if (ignored != 0)
        ...
        public MVAFCrystalInstancePara(Ctx ctx, int AD_CrystalInstace_ID, int SeqNo)
            : base(ctx, 0, null)
        {
        ...
        public MVAFCrystalInstancePara(MVAFCrystalInstance instance, int SeqNo)
        ...
        public MVAFCrystalInstancePara(Ctx ctx, DataRow dr, Trx txtName)
            : base(ctx, dr, txtName)
        {
        }
